...
{
    public class BranchProduct_SalesTax
    {
        public BranchProduct_SalesTax()
        { 
        
        }

        public List<BranchProductSalesTaxItems> GetBranchProductSalesTax()
        {
            Type Source = System.Reflection.MethodBase.GetCurrentMethod().DeclaringType;
            List<BranchProductSalesTaxItems> ProductSalesTax = new List<BranchProductSalesTaxItems>();
            try
            {
                ...
                sSQL = sSQL + " from Product_Branch_Sales_Tax PB ,Sales_Tax_Master STM,Product_Group_Master PGM,Party_Type_Master PTM,Branch_Master BM ";
                ...
                using (IDataReader reader = ImpalDB.ExecuteReader(cmd1))
                {
                    while (reader.Read())
                    {
                        BranchProductSalesTaxItems objValue = new BranchProductSalesTaxItems();
        ...
        public BranchProductSalesTaxItems getSalesIndicatorAndPercentage(string strSaleTaxCode)
        {
            Type Source = System.Reflection.MethodBase.GetCurrentMethod().DeclaringType;
            BranchProductSalesTaxItems objValue = new BranchProductSalesTaxItems();
            try
        ...
        public int CheckDuplicate(BranchProductSalesTaxItems objVlaue)
        {
            Type Source = System.Reflection.MethodBase.GetCurrentMethod().DeclaringType;
            int iRowCount = -1;
            try
        ...
        public int InsBranchProductSalesTax(BranchProductSalesTaxItems objVlaue)
        {
            Type Source = System.Reflection.MethodBase.GetCurrentMethod().DeclaringType;
            int iRowCount = -1;
            ...
            try
            {
                using (TransactionScope scope = DataAccess.NewWriteTransactionScope())
                {
                    ...
                    DbCommand cmd = ImpalDB.GetStoredProcCommand("usp_addproductbranchsalestax");
        ...
        public int UpdBranchProductSalesTax(BranchProductSalesTaxItems objVlaue)
        {
            Type Source = System.Reflection.MethodBase.GetCurrentMethod().DeclaringType;
            int iRowCount = -1;
            ...
            try
            {
                ...
                {
                    Database ImpalDB = DataAccess.GetDatabase();
                    DbCommand cmd = ImpalDB.GetStoredProcCommand("usp_updproductbranchsalestax");
        ...
        public BranchProductSalesTaxItems getBranchProductSalesTaxSerialNo(string strSerialNumber)
        {
            Type Source = System.Reflection.MethodBase.GetCurrentMethod().DeclaringType;
            BranchProductSalesTaxItems objValue = new BranchProductSalesTaxItems();
            try
            {
                ...
                Database ImpalDB = DataAccess.GetDatabase();
                DbCommand cmd = ImpalDB.GetStoredProcCommand("Usp_Getproductbranchsalestax");
    ...
    public class BranchProductSalesTaxItems
    {
        public BranchProductSalesTaxItems()
        {             
        }
