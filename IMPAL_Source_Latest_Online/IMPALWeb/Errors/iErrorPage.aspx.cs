...
{
    public partial class iErrorPage : System.Web.UI.Page
    {
        ...
        {
            Exception caughtException = (Exception)Application["ExceptionMesage"];
            Exception caughtExceptionUrl = (Exception)Application["ExceptionURL"];
            lblErrorContentDisplaySubText.Text = caughtExceptionUrl.Message.ToString() + "<br><br>" + caughtException.Message.ToString();
        }
        ...
        private void LoadPageNotFoundMessages()
        {
            ...
            lblErrorRightSubText.Text = "Please contact HO.";
        }
