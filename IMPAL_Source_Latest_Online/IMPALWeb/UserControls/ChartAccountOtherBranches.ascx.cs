...
{
    public partial class ChartAccountOtherBranches : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["BranchCodeOthers"] != null)
                hddBranch.Value = Session["BranchCodeOthers"].ToString();
            else
