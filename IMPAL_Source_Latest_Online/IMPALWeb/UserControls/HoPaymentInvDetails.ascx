<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HoPaymentInvDetails.ascx.cs"
    Inherits="IMPALWeb.UserControls.HoPaymentInvDetails" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajax" %>
<div class="modalIconHolder">
    <asp:Button ID="btnEdit" runat="server" Style="width: 30px !important;" Text="Edit"
        SkinID="ButtonNormal" OnClientClick="javascript:showHoPaymentChild(this.id);"
        OnClick="btnEdit_Click"></asp:Button>
    <asp:Button ID="imgPopupHidden" Style="display: none" runat="server" />
    <ajax:ModalPopupExtender ID="MPEHOPayment" runat="server" TargetControlID="imgPopupHidden"
...
<div id="divPopup" class="divPopup" runat="server" style="display: none;width:870px;height:500px;overflow-y: auto;">
    ...
    <div id="divItemDetails" runat="server">
        ...
        <div id="idGrid" runat="server">
            <asp:GridView ID="grvHOPaymentInvoiceDetails" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="InvValue - CD.Amt">
                        <ItemTemplate>
