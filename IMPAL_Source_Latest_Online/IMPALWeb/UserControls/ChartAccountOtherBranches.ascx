<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChartAccountOtherBranches.ascx.cs"
    Inherits="IMPALWeb.UserControls.ChartAccountOtherBranches" %>
...
<div class="modalIconHolder">
    <asp:ImageButton ID="imgPopup" runat="server" SkinID="ImageButtonSearchPopup" ImageUrl="~/images/iHelpScreen.png"
        OnClientClick="LoadMainOthers(this);" />
        ...
        <table class="modalExtenderTable">
            <tr>
                ...
                <td class="inputcontrols">
                    <select id="drpGlMain" runat="server" class="dropDownListNormalPopup" onchange="LoadSubOthers(this);">
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td class="inputcontrols">
                    <select id="drpGlSub" runat="server" class="dropDownListNormalPopup" onchange="LoadAccOthers(this);">
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td class="inputcontrols">
                    <select id="drpGlAccount" runat="server" class="dropDownListNormalPopup" onchange="LoadBranchOthers(this);">
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td class="inputcontrols">
                    <select id="drpBranch" runat="server" class="dropDownListNormalPopup" onchange="LoadChartAccountCodeOthers(this);">
                    </select>
                </td>
            </tr>
            <tr>
