...
{
    public partial class HoPaymentInvDetails : System.Web.UI.UserControl
    {
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Session["HOPaymentBranch"] = txtBranch.Text; ;
                Session["HOPaymentInvAmt"] = txtAdjTotal.Text;
                Session["HOPaymentCdAmt"] = txtCDTotal.Text;

                if (hdnCnt.Value != null && hdnCnt.Value != "")
                    Session["HOhdnCnt"] = hdnCnt.Value;
                else
                    Session["HOhdnCnt"] = grvHOPaymentInvoiceDetails.Rows.Count;
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                List<PaymentProcessTemp> lstDetail = objPayable.LoadCorporateHOPaymentBranchTotalTempInvoice(supplier, fromdate, todate, branch);
                grvHOPaymentInvoiceDetails.DataSource = lstDetail;
                grvHOPaymentInvoiceDetails.DataBind();
