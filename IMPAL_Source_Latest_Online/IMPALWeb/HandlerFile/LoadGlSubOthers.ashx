<%@ WebHandler Language="C#" Class="LoadGlSubOthers" %>
...
public class LoadGlSubOthers : IHttpHandler
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (Filter == "('GSTOPTIONS')")
            GlBranch = acc.GetGlSubGSTOptionsOthers(GlMain);
        else
            GlBranch = acc.GetGlSubOthers(GlMain);
