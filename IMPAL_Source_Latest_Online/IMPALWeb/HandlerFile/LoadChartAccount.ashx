<%@ WebHandler Language="C#" Class="LoadChartAccount" %>
...
public class LoadChartAccount : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        ChartDetails ChartDetails = acc.GetChartDetails(GlMain, GlSub, GlAcc, Branch);
