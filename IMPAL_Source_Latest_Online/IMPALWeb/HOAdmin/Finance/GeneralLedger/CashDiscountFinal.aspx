<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="CashDiscountFinal.aspx.cs" Inherits="IMPALWeb.HOAdmin.Finance.GeneralLedger.CashDiscountFinal" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportFilters">
        <asp:UpdatePanel ID="upHOCashDiscount" runat="server">
            <ContentTemplate>
