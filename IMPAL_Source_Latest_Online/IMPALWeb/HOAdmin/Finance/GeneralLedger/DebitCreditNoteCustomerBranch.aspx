<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="DebitCreditNoteCustomerBranch.aspx.cs" Inherits="IMPALWeb.HOAdmin.Finance.General_Ledger.DebitCreditNoteCustomerBranch" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<asp:Content ID="Content" ContentPlaceHolderID="CPHDetails" runat="server">
    <div class="reportFormTitle">
        DEBIT/CREDIT Note - Customer/Branch</div>
    <div class="reportFilters">
        <asp:UpdatePanel ID="upHODrCrBranch" runat="server">
            <ContentTemplate>
