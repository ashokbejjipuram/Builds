<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="TCSExemption.aspx.cs"
    Inherits="IMPALWeb.TCSExemption" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function FnValidate() {
            ...
            var ddlExemptionStatus = document.getElementById('ctl00_CPHDetails_ddlExemptionStatus');
            ...
            if (ddlExemptionStatus.value.trim() == "" || ddlExemptionStatus.value.trim() == null) {
                alert('Please Select the Exemption Status');
                ddlExemptionStatus.focus();
                return false;
            }
        }
    </script>
                        ...
                        <td>
                            ...
                            <div id="divOSdetails" style="display: none" runat="server">
                                ...
                                <table class="reportFiltersTable">
                                    <tr>
                                        <td class="label">
                                            <asp:Label runat="server" ID="Label1" Text="Existing TCS Exemption Status" SkinID="LabelNormal" />
                                        </td>
                                        <td class="inputcontrols">
                                            <asp:DropDownList ID="ddlExemptionStatus" runat="server" SkinID="DropDownListNormal">
