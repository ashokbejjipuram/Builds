    ...
    public partial class CustomerStatus : System.Web.UI.Page
    {
        ...
        protected void ddlCustomer_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlCustomer.SelectedIndex > 0)
            {
                ...
                ddlCustomerStatus.SelectedValue = customer.GetCustomerStatus(ddlBranch.SelectedValue, ddlCustomer.SelectedValue);
            }
            else
            {
                BtnSubmit.Visible = false;
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                customer.UpdateCustomerStatus(ddlBranch.SelectedValue, ddlCustomer.SelectedValue, ddlCustomer.SelectedItem.Text, txtLocation.Text, ddlCustomerStatus.SelectedValue);

                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Customer Status has been Updated Succesfully');", true);
                ddlCustomer.Enabled = false;
        ...
        protected void BtnReset_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("CustomerStatus.aspx", false);
