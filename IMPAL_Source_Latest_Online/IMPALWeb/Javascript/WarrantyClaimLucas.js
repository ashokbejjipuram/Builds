...
function WarrantyClaimHeaderValidation() {
    var ddlBrnch = document.getElementById(CtrlIdPrefix + "ddlBranch");
    var Branch = ddlBrnch.options[ddlBrnch.selectedIndex].value;
    ...
    var ddlShipTo = document.getElementById(CtrlIdPrefix + "ddlShipTo");
    ...
    var ShipTo = ddlShipTo.options[ddlShipTo.selectedIndex].value;

    if (ShipTo == "0") {
        alert('Please select a Ship To.');
        ddlShipTo.focus();
        return false;
    }
...
function WarrantyClaimEntrySubmit(s) {
    if (s != "M") {
        if (WarrantyClaimHeaderValidation()) {
        ...
        var Status = "Are you Sure to Approve the Warranty Claim Entry";
...
function funWarrantyClaimReject() {
    var Remarks = prompt("Are you Sure to Reject the Warranty Claim Entry? Please Give the Reason Below.");
...
function funWarrantyClaimCancel() {
    var Remarks = prompt("Are you Sure to Cancel the Warranty Claim Entry? Please Give the Reason Below.");
