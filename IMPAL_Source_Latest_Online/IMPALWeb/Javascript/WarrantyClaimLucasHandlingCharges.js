...
function funBtnAddRow() {
    //alert('asda');
    if (WarrantyClaimHeaderValidation()) {
...
function HandlingChargesHeaderValidation() {
    var ddlBrnch = document.getElementById(CtrlIdPrefix + "ddlBranch");
    var Branch = ddlBrnch.options[ddlBrnch.selectedIndex].value;
    ...
    var txtHandlingCharges = document.getElementById(CtrlIdPrefix + "txtHandlingCharges");
    var txtJobCardNo = document.getElementById(CtrlIdPrefix + "txtJobCardNumber");
    var txtJobCardDate = document.getElementById(CtrlIdPrefix + "txtJobCardDate");

    var ddlSupplyPlant = document.getElementById(CtrlIdPrefix + "ddlSupplyPlant");
    var txtShipTo = document.getElementById(CtrlIdPrefix + "txtShipTo");
    ...
    if (txtHandlingCharges.value.trim() == "" || txtHandlingCharges.value.trim() == null) {
        alert('Please Enter Handling Charges.');
        txtHandlingCharges.focus();
        return false;
    }

    if (!CurrencyChkForMoreThanOneDot(txtHandlingCharges.value.trim())) {
        alert("Please enter valid Handling Charges.");
        txtHandlingCharges.focus();
        return false;
    }

    if (txtHandlingCharges.value.trim() == "0.00" || parseFloat(txtHandlingCharges.value.trim()) == 0) {
        alert("Handling Chargese should be greater than zero.");
        txtHandlingCharges.focus();
        return false;
    }

    if (txtJobCardNo.value.trim() == "" || txtJobCardNo.value.trim() == null) {
        alert('Please Enter Job Card Number.');
        txtJobCardNo.focus();
        return false;
    }

    if (txtJobCardDate.value.trim() == "" || txtJobCardDate.value.trim() == null) {
        alert('Please Enter Job Card Date.');
        txtJobCardDate.focus();
        return false;
    }

    //if (txtShipTo.value.trim() == "" || txtShipTo.value.trim() == null) {
    //    alert('Please Enter a Ship To.');
    //    txtShipTo.focus();
    //    return false;
    //}
...
function HandlingChargesEntrySubmit(s) {
    if (s != "M") {
        if (HandlingChargesHeaderValidation()) {
        ...
        var Status = "Are you Sure to Approve the Handling Charges Entry";
...
function funWarrantyClaimReject() {
    var Remarks = prompt("Are you Sure to Reject the Handling Charges Entry? Please Give the Reason Below.");
...
function funWarrantyClaimCancel() {
    var Remarks = prompt("Are you Sure to Cancel the Handling Charges Entry? Please Give the Reason Below.");
