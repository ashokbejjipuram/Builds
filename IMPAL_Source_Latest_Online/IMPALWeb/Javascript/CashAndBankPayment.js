...
function calculateTotal() {
    ...
    var total = 0;
    var grd = document.getElementById('ctl00_CPHDetails_grvCashAndBankPayment');
    ...
    document.getElementById("ctl00_CPHDetails_grvCashAndBankPayment_ctl" + rownum + "_txtTotalAmount").value = parseFloat(Math.round(total * 100) / 100).toFixed(2);
}
