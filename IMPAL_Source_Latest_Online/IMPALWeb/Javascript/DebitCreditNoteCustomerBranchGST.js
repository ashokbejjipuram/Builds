...
function ValidateDebitCreditFields() {
    ...
    else if (validate(document.getElementById(CtrlIdPrefix + "txtGSTValue").value, "GST Value ")) {
...
function CalAdjustValue() {
    ...
    for (var x = 1; x < gvDrv.rows.length - 1; x++) {
        ...
        if (Check.checked) {
            if (hddreturnQntCA == "1") {
                if (!(ddlTransactionType == "652" || ddlTransactionType == "654" || ddlTransactionType == "655" || ddlTransactionType == "656" || ddlTransactionType == "657" || ddlTransactionType == "757" || ddlTransactionType == "752" || ddlTransactionType == "754" || ddlTransactionType == "755" || ddlTransactionType == "756" || ddlTransactionType == "757")) {
                    txtSGST.value = 0;
                    txtCGST.value = 0;
                    txtIGST.value = 0;
                    txtUTGST.value = 0;
    ...
    if (Type != null) {
        if (Type == "1") {
            ...
            for (var x = 1; x < ObjGrid.rows.length - 1; x++) {
                ...
                if (hdnChart == "1") {
                    if (txtBranch.value.toUpperCase() == "CHANDIGARH") {
                        if (UTGSTPer.value == "0" && IGSTPer.value == "0") {
                            alert("UTGST % is required");
                            return false;
                        }

                        if (UTGSTAmt.value == "0" && IGSTPer.value == "0") {
                            alert("UTGST Amt is required");
                            return false;
                        }
                    }
                    else {
                        if (SGSTPer.value == "0" && IGSTPer.value == "0") {
                            alert("SGST % is required");
                            return false;
                        }

                        if (SGSTAmt.value == "0" && IGSTPer.value == "0") {
                            alert("SGST Amt is required");
                            return false;
                        }
                    }

                    if (CGSTPer.value == "0" && IGSTPer.value == "0") {
                        alert("CGST % is required");
                        return false;
                    }

                    if (CGSTAmt.value == "0" && IGSTPer.value == "0") {
                        alert("CGST Amt is required");
                        return false;
                    }

                    if (txtBranch.value.toUpperCase() == "CHANDIGARH") {
                        if (UTGSTPer.value == "0" && CGSTPer.value == "0") {
                            if (IGSTPer.value == "0") {
                        ...
                        if (SGSTPer.value == "0" && CGSTPer.value == "0") {
                            if (IGSTPer.value == "0") {
                                alert("IGST % is required");
                                return false;
                            }
            ...
            var hdntxtRoundoff = (parseFloat(txtAmount.value) + parseFloat(txtGSTAmount.value)) - parseFloat(CollectAmount);
            ...
            hdntxtRoundoff.value = parseFloat(document.getElementById(CtrlIdPrefix + "txtTotalAmount").value) - parseFloat(document.getElementById(CtrlIdPrefix + "txtCollectedAmount").value);
