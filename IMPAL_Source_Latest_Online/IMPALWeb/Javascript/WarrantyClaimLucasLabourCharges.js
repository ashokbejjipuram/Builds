...
function LabourChargesHeaderValidation() {
    var ddlBrnch = document.getElementById(CtrlIdPrefix + "ddlBranch");
    var Branch = ddlBrnch.options[ddlBrnch.selectedIndex].value;
    ...
    var txtLabourCharges = document.getElementById(CtrlIdPrefix + "txtLabourCharges");
    ...
    if (txtLabourCharges.value.trim() == "" || txtLabourCharges.value.trim() == null) {
        alert('Please Enter Labour Charges.');
        txtLabourCharges.focus();
        return false;
    }

    if (!CurrencyChkForMoreThanOneDot(txtLabourCharges.value.trim())) {
        alert("Please enter valid Labour Charges.");
        txtLabourCharges.focus();
        return false;
    }

    if (txtLabourCharges.value.trim() == "0.00" || parseFloat(txtLabourCharges.value.trim()) == 0) {
        alert("Labour Chargese should be greater than zero.");
        txtLabourCharges.focus();
        return false;
    }
...
function LabourChargesEntrySubmit(s) {
    if (s != "M") {
        if (LabourChargesHeaderValidation()) {
        ...
        var Status = "Are you Sure to Approve the Labour Charges Entry";
...
function funWarrantyClaimReject() {
    var Remarks = prompt("Are you Sure to Reject the Labour Charges Entry? Please Give the Reason Below.");
...
function funWarrantyClaimCancel() {
    var Remarks = prompt("Are you Sure to Cancel the Labour Charges Entry? Please Give the Reason Below.");
