...
function SalesInvoiceQtyChangeGST(RowNum, CanOrderQtyID, HdnReqOrderQtyID, QuantityID, SLBID, ItemSaleValueID, DiscountID) {
    ...
    if (Quantity != null && Quantity != "") {        
        if (isNaN(Quantity.value)){   
            alert("Please enter valid Quantity in row " + RowNum);
            SLB.disabled = true;
            Quantity.focus();
            return false;        
        }
    ...
    if (!(cTransactionType.value == "041" || cTransactionType.value == "141" || cTransactionType.value == "141"))
        SLB.disabled = false;
    else
        SLB.disabled = true;
...
function SalesInvoiceCouponChange(CanOrderQtyID, QuantityID, ItemSaleValueID) {
    ...
    var CanBillUpTo = document.getElementById(CtrlIdPrefix + "txtCanBillUpTo");
    var span = document.getElementById(CtrlIdPrefix + "lblHeaderMessage");
    var CostToCostCoupon = document.getElementById(CtrlIdPrefix + "hdnCostToCostCoupon");
    ...
    if (gItemsDtl != null) {
        ...
        if (rowscount >= 1) {
            ...
            for (i = 0; i < txtInputs.length; i++) {
                ...
                var ReqOrderQty = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "txtHdnReqOrderQty");
                var Quantity = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "txtQuantity");
                var ddlSLB = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "ddlSLB");
                var ItemSaleValue = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "txtItemSaleValue");
                var Coupon = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "txtDiscount");
                var ActualCoupon = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "txtOrgCoupon");
                    ...
                    if (txtInputs[i].id == Quantity.id) {
                        if (txtInputs[i].value == "0" || txtInputs[i].value == "") {
                            ...
                            if (parseInt(Quantity.value.trim()) > 0 && (cTransactionType.value != "461")) {
                                ...
                                if (cTransactionType.value == "481" && CostToCostCoupon.value == "Y")
                                {
                                    if (parseFloat(Coupon.value.trim()) > parseFloat(ActualCoupon.value.trim())) {
                                        alert('Coupon Cannot exceed the Actual Coupon Rs.' + ActualCoupon.value.trim());
                                        Coupon.value = parseFloat(ActualCoupon.value.trim());
                                        Coupon.focus();
                                        return false;
                                    }
                                }
                                ...
                                if ((ItemSaleValue != null) && (ItemSaleValue != undefined) && (ItemSaleValue.value != 0)) {
                                    ...
                                    if (parseFloat(Coupon.value.trim()) < 0)
                                        Coupon.value = (-1) * Coupon.value;
                                
                                    rowItemQtySaleValue = (parseFloat(ItemSaleValue.value.trim()) + (parseFloat(ItemSaleValue.value.trim()) * (-1) * parseFloat(Coupon.value.trim() / 100))) * parseInt(Quantity.value.trim());
            ...
            for (k = 1; k < gItemsDtl.rows.length; k++) {
                if (document.getElementById(CtrlIdPrefix + "hdnRowCnt").value == "0") {
                    ...
                    if (txtSno != null) {
                        ...
                        txtOrgDiscount = row.cells[8].children[1];
...
//                            }
                        ...
                        if (!(cTransactionType.value == "041" || cTransactionType.value == "141" || cTransactionType.value == "481")) {
                            if (txtOrgDiscount.id != null && txtOrgDiscount.id != "") {
                                if (parseFloat(txtDiscount.value) > parseFloat(txtOrgDiscount.value)) {
                                    alert("Coupon Should not exceed " + txtOrgDiscount.value + " in row " + k);
                        ...
                        if (!(cTransactionType.value == "071" || cTransactionType.value == "171")) {
                            if (!(cTransactionType.value == "361" || ddlBranch.value == "SIL")) {
...
//    var TaxFilter = document.getElementById(CtrlIdPrefix + "ddlTaxFilter");    
...
function SalesInvoiceEntrySubmit() {
    ...
    if (status == null) {
        ...
        var Remarks = prompt("Are you Sure to Cancel the Invoice? Please Give the Reason Below.");
