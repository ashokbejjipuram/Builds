...
function checkDateForRefDocDate(id) {
    ...
    if (idDate != '') {
        ...
        if (!status) {
            ...
            var idInvoiceDate = document.getElementById(id).value;
...
function AlphaNumericWithSpecialCharactes(id) {
    var idvalue = document.getElementById(id).value;
    document.getElementById(id).value = idvalue.replace(/[^a-zA-Z0-9 \/\-\_.]/g, "");
}
...
function funModeOfPayment() {    
    var id = document.getElementById(CtrlIdPrefix + 'ddlCashCheque');
    
    if (id.value == 'H' || id.value == 'D') {        
        ...
        document.getElementById(CtrlIdPrefix + 'txtChequeDate').value = document.getElementById(CtrlIdPrefix + 'hdnChequeDate').value;
        document.getElementById(CtrlIdPrefix + 'txtBank').value = document.getElementById(CtrlIdPrefix + 'hdnBank').value;
        document.getElementById(CtrlIdPrefix + 'txtBankBranch').value = document.getElementById(CtrlIdPrefix + 'hdnBankBranch').value;
        document.getElementById(CtrlIdPrefix + 'ddlLocalOutstation').value = document.getElementById(CtrlIdPrefix + 'hdnLocalOutstation').value;
...
function funBtnAddRow() {
    if (HeaderValidation()) {
        ...
        //document.getElementById(CtrlIdPrefix + 'txtTransactionAmount').disabled = true;
        //document.getElementById(CtrlIdPrefix + 'BankAccNo_imgPopup').style.display = "none";
        //document.getElementById(CtrlIdPrefix + 'ddlCashCheque').disabled = true;
        //document.getElementById(CtrlIdPrefix + 'txtChequeNumber').disabled = true;
        //document.getElementById(CtrlIdPrefix + 'txtChequeDate').disabled = true;
        //document.getElementById(CtrlIdPrefix + 'txtBank').disabled = true;
        //document.getElementById(CtrlIdPrefix + 'txtBankBranch').disabled = true;
        //document.getElementById(CtrlIdPrefix + 'ddlLocalOutstation').disabled = true;
        //document.getElementById(CtrlIdPrefix + 'txtReferenceDate').disabled = true;
...
function HeaderValidation() {
    ...
    if (validatespl(Remarks, "Remarks ")) {
        document.getElementById(CtrlIdPrefix + "txtRemarks").focus();
        return false;
    }
...
function GridValidate(id) {
    ...
    if (HeaderValidation())
    {
        ...
        for (j = 1; j < gvDrv.rows.length - 1; j++) {
            ...
            txtBranch = row.cells[1].children[0];
            txtAmount = row.cells[2].children[0];
            txtBankRefNo = row.cells[3].children[0];
            txtNeftDate = row.cells[4].children[0];
            txtRemarks = row.cells[5].children[0];
            
            if (txtBranch.value.trim() == "" || txtBranch.value == "0" || txtBranch.value == null) {
                alert("Branch should not be null");
                txtBranch.focus();
                return false;
            }
            
            if (txtAmount.value.trim() == "" || txtAmount.value == null) {
            ...
            if (txtBankRefNo.value.trim() == "" || txtBankRefNo.value == null) {
                alert("Bank Ref. No. should not be null");
                txtBankRefNo.value = "";
                txtBankRefNo.focus();
                return false;
            }
            
            if (txtNeftDate.value.trim() == "" || txtNeftDate.value == null) {
                alert("NEFT Date should not be null");
                txtNeftDate.value = "";
                txtNeftDate.focus();
                return false;
            }
            ...
            if (txtNeftDate.value.trim() == "" || txtNeftDate.value == null) {
                var status = fnIsDate(txtNeftDate.value.trim());
                ...
                if (!status) {
                    ...
                    IdDate = convertDate(txtNeftDate.value.trim());
            ...
            if (txtRemarks.value.trim() == "" || txtRemarks.value == null) {
                alert("Remarks should not be null");
                txtRemarks.value = "";
                txtRemarks.focus();
                return false;
            ...
            if (txtAmount.value.trim() != "") {
                totalAmount = totalAmount + parseFloat(txtAmount.value.trim());
