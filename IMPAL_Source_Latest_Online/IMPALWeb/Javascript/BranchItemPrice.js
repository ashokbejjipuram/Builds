    ...
    if (gItemsDtl != null) {
        ...
        if (rowscount >= 3) {
            for (k = 1; k < gItemsDtl.rows.length; k++) {
                ...
                var ddlPurchaseDiscount = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "ddlPurchaseDiscount");
                var txtListLessDiscount = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "txtListLessDiscount");
                var ddlCoupon = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "ddlCoupon");
                var txtAfterCoupon = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "txtAfterCoupon");
                var ddlCDPercentage = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "ddlCDPercentage");
                ...
                var ddlWCPercentage = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "ddlWCPercentage");
                ...
                if (ddlPurchaseDiscount.value.trim() == "") {
                    alert("Purchase Discount Shoud not be Null");
                    ddlPurchaseDiscount.focus();
                    return false;
                }
                ...
                if (ddlCDPercentage.value.trim() == "") {
                    alert("CD Percentage Shoud not be Null");
                    ddlCDPercentage.focus();
                    return false;
                }
                ...
                if (ddlWCPercentage.value.trim() == "") {
                    alert("WC Percentage Shoud not be Null");
                    ddlWCPercentage.focus();
                    return false;
                }
                ...
                if (parseFloat(txtListPrice.value) < parseFloat(txtCostPrice.value)) {
                    alert("List Price Should be Greater than or equal to Cost Price. Please Check and Submit.");
                    txtListPrice.focus();
                    return false;
                }

                if (parseFloat(txtCostPrice.value) == parseFloat(txtListPrice.value)) {
                    alert("List Price and Cost Price are Matching. Please Make Sure.");
                    txtListPrice.focus();
                }                
            }
        }
...
function fnCalculate(id) {
    ...
    var PurDisc = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "ddlPurchaseDiscount");
    var ListLessDisc = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "txtListLessDiscount");
    var Coupon = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "ddlCoupon");
    var AfterCoupon = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "txtAfterCoupon");
    var CDPer = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "ddlCDPercentage");
    ...
    var WCPer = document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "ddlWCPercentage");
    ...
    document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "hdnListLessDiscount").value = parseFloat(ListLessDisc.value);
    document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "hdnAfterCoupon").value = parseFloat(AfterCoupon.value);
    document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "hdnCDAmount").value = parseFloat(CDAmt.value);
    document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "hdnAfterCD").value = parseFloat(AfterCD.value);
    document.getElementById(CtrlGridRowIdPrefix + CtrlGridRowId + "hdnWCAmount").value = parseFloat(WCAmt.value);
