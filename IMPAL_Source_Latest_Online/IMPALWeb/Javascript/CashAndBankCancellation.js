...
function ValidateDocNo() {
    ...
    var txtTransactionNumber = document.getElementById(CtrlIdPrefix + "txtTransactionNumber");
    ...
    if (txtTransactionNumber != null) {
        if (txtTransactionNumber.value.trim() == "" || txtTransactionNumber.value.trim() == "0") {
            alert('Please Enter a C B Number to Cancel.');
...
function funCBCancellationSubmit() {
    var ddlBranch = document.getElementById(CtrlIdPrefix + "ddlBranch");
    var txtTransactionNumber = document.getElementById(CtrlIdPrefix + "txtTransactionNumber");
    ...
    if (txtTransactionNumber != null) {
        ...
        if (txtTransactionNumber.value.trim() == "") {
            alert('Please Enter a C B Number to Cancel.');
            imgEditToggle.focus();
            return false;
        }
    ...
    var ddlTransactionNumber = document.getElementById(CtrlIdPrefix + "ddlTransactionNumber");

    if (ddlTransactionNumber == null) {
        alert('Please Click on the Search Image to Load C B Number.');
        imgEditToggle.focus();
        return false;
    }
    else
        var TransactionNumber = ddlTransactionNumber.options[ddlTransactionNumber.selectedIndex].value;

    if (TransactionNumber == "0") {
        alert('Please select a C B Number to Cancel.');
        ddlTransactionNumber.focus();
        return false;
    }

    var txtReason = document.getElementById(CtrlIdPrefix + "txtReason");

    if (txtReason.value.trim() == "") {
        alert('Please Enter the Reason to Cancel.');
        txtReason.focus();
        return false;
    }

    if (confirm("Are you Sure to Cancel the C B Transaction?"))
        return true;
    else
        return false;
}
