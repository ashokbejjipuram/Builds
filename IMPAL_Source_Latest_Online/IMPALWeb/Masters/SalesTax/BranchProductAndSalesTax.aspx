<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="BranchProductAndSalesTax.aspx.cs"
    Inherits="IMPALWeb.Masters.SalesTax.BranchProductAndSalesTax" %>
...
<asp:Content ID="CPHDetails" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <script type="text/javascript">
        function pageLoad(sender, args) {
            ...
            gridViewFixedHeader('<%=GV_BrnProductSalesTax.ClientID%>', '1200', '800');
        }
    </script>

    <div id="DivOuter">
        <div class="subFormTitle subFormTitleExtender300">
            BRANCH PRODUCT AND SALES TAX
        </div>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div class="gridViewScrollFullPage">
                    <asp:GridView ID="GV_BrnProductSalesTax" runat="server" AllowPaging="false" ShowFooter="True"
                        AutoGenerateColumns="False" SkinID="GridViewScroll" OnPageIndexChanging="GV_BrnProductSalesTax_PageIndexChanging"
                        OnRowDataBound="GV_BrnProductSalesTax_RowDataBound" OnRowEditing="GV_BrnProductSalesTax_RowEditing"
                        OnRowUpdating="GV_BrnProductSalesTax_RowUpdating" OnRowCancelingEdit="GV_BrnProductSalesTax_RowCancelingEdit">
                        <EmptyDataTemplate>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Branch" SortExpression="GVBranchCode">
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:RequiredFieldValidator ID="ReqddlBranch" ValidationGroup="btnAdd" ForeColor="Red"
                                        SkinID="Error" ControlToValidate="ddlBranch" Display="None" InitialValue="0"
                                        runat="server" ErrorMessage="Please select Branch.">
                            ...
                            <asp:TemplateField HeaderText="Product Group" SortExpression="Product_Group_Desc">
                                ...
                                <EditItemTemplate>
                                    <asp:DropDownList ID="ddlProduct" Enabled="false" runat="server" SkinID="GridViewDropDownListFooter">
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="ReqddlProduct" ValidationGroup="btnAdd" ForeColor="Red"
                                        SkinID="Error" ControlToValidate="ddlProduct" Display="None" InitialValue="0"
                                        runat="server" ErrorMessage="Please Select Product.">
                                    </asp:RequiredFieldValidator>
                            ...
                            <asp:TemplateField HeaderText="Sales Tax" SortExpression="Sales_Tax_Desc">
                                ...
                                <EditItemTemplate>
                                    <asp:DropDownList ID="ddlSalesTax" runat="server" SkinID="GridViewDropDownListFooter"
                                        OnSelectedIndexChanged="ddlSalesTax_SelectedIndexChanged" AutoPostBack="True">
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="ReqddlSalesTax" ValidationGroup="btnAdd" ForeColor="Red"
                                        SkinID="Error" ControlToValidate="ddlSalesTax" Display="None" InitialValue="0"
                                        runat="server" ErrorMessage="Please select Sales Tax.">
                                    </asp:RequiredFieldValidator>
                            ...
                            <asp:TemplateField HeaderText="Percentage" SortExpression="Sales_Tax_Percentage">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtPercentage" ReadOnly="true" SkinID="GridViewTextBox" Text='<%# Bind("Sales_Tax_Percentage") %>'
                                        runat="server" />
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <edititemtemplate>
                                                    <asp:TextBox ID="txtPercentage" SkinID="GridViewTextBox"  ReadOnly="true" runat="server" > </asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="Indicator" SortExpression="Sales_Tax_Indicator">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtIndicator" ReadOnly="true" SkinID="GridViewTextBox" Text='<%# Bind("Sales_Tax_Indicator") %>'
                                        runat="server" />
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <edititemtemplate>
                                                    <asp:TextBox ID="txtIndicator" ReadOnly="true" SkinID="GridViewTextBox" runat="server" ></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="Sale Tax" SortExpression="Sales_Tax_Text">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtSaleTaxText" SkinID="GridViewTextBox" Text='<%# Bind("Sales_Tax_Text") %>'
                                        runat="server" />
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <edititemtemplate>
                            ...
                            <asp:TemplateField HeaderText="Form Name" SortExpression="Form_Name_Text">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtFormNameText" SkinID="GridViewTextBox" Text='<%# Bind("Form_Name_Text") %>'
                                        runat="server" />
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <edititemtemplate>
                            ...
                            <asp:TemplateField HeaderText="Status" SortExpression="Status">
                                <ItemTemplate>
                                    <asp:Label ID="lblStatus" runat="server" Text='<%# Bind("Status") %>' SkinID="GridViewLabel">
                                    </asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField ShowHeader="true">
                                <FooterTemplate>
                                    <itemtemplate>
                                                ...
                                                CommandName="Add" Text="Add" onclick="btnAdd_Click"  />
                                         </itemtemplate>
                                </FooterTemplate>
