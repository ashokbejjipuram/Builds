<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="ItemMasterNew.aspx.cs"
    Inherits="IMPALWeb.Masters.Item.ItemMasterNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div>
        <asp:UpdatePanel ID="updateItemMasterNew" runat="server">
            <ContentTemplate>
                ...
                <asp:Panel ID="PnlItemMasterNew" runat="server">
                        ...
                        <ItemTemplate>
                            <table id="tblHeader" class="subFormTable">
                                ...
                                <tr>
                                    ...
                                    <td class="inputcontrols">
                                        <asp:TextBox ID="txtItemCode" ReadOnly="true" Enabled="false" runat="server" Text='<%# Eval("Item_Code") %>'
                                ...
                                <tr>
                                    ...
                                    <td class="inputcontrols">
                                        <asp:TextBox ID="txtHSNCode" runat="server" Text='<%# Eval("Item_Type_Code") %>'
                                            SkinID="TextBoxNormalBig" MaxLength="8" onkeypress="return IntegerValueOnly();">
                                        </asp:TextBox>
                                    </td>
                                    <td class="label">
