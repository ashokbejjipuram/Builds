...
{
    public partial class ProductGroupReport : System.Web.UI.Page
    {
        #region page init
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack && PreviousPage != null)
                {
                    ...
                    crProductGroup.ReportName = "ProductGroup";
                    crProductGroup.RecordSelectionFormula = "";
                    crProductGroup.GenerateReport();
                    if (crProductGroup.Visible == false)
                        crProductGroup.Visible = true;
                }
            }
            catch (Exception exp)
            {
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("ProductGroup.aspx", false);
