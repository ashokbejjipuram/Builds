<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BranchItemPrice.aspx.cs"
    Inherits="IMPALWeb.HOAdmin.Item.BranchItemPrice" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDetails" runat="server">

    <script language="javascript" src="../../Javascript/BranchItemPrice.js" type="text/javascript"></script>

    <div class="reportFormTitle reportFormTitleExtender350">
        BRANCH ITEM PRICE - LIST / COST PRICE DETAILS
    </div>
    <div class="reportFilters">
        <table id="reportFiltersTable" class="reportFiltersTable" runat="server" visible="false">
            <tr>
                <td class="label">
        ...
        <asp:UpdatePanel ID="UpdPanelGrid" runat="server" UpdateMode="Conditional">
            ...
            <ContentTemplate>
                <asp:GridView ID="grdItemDetails" runat="server" SkinID="GridViewScroll" AutoGenerateColumns="False" OnRowDataBound="grdItemDetails_OnRowDataBound"
                    OnRowDeleting="grdItemDetails_RowDeleting">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="List Price">
                            <ItemTemplate>
                                <asp:TextBox ID="txtListPrice" Style="width: 80px" SkinID="GridViewTextBox" runat="server" onchange="javascript:return fnCalculate(this.id);" onkeypress="return CurrencyNumberOnly(this.id)" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Pur. Disc %">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlPurchaseDiscount" Style="width: 60px" SkinID="GridViewDropDownList" runat="server" onchange="javascript:return fnCalculate(this.id);">
                        ...
                        <asp:TemplateField HeaderText="ListLess Disc">
                            <ItemTemplate>
                                <asp:TextBox ID="txtListLessDiscount" Style="width: 80px" Enabled="false" SkinID="TextBoxDisabled" runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Coupon">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlCoupon" Style="width: 60px" SkinID="GridViewDropDownList" runat="server" onchange="javascript:return fnCalculate(this.id);">
                                    <asp:ListItem Text="0" Value="0"></asp:ListItem>
                                </asp:DropDownList>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="CD %">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlCDPercentage" Style="width: 60px" SkinID="GridViewDropDownList" runat="server" onchange="javascript:return fnCalculate(this.id);">
                                    <asp:ListItem Text="0" Value="0"></asp:ListItem>
                                </asp:DropDownList>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="WC %">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlWCPercentage" Style="width: 60px" SkinID="GridViewDropDownList" runat="server" onchange="javascript:return fnCalculate(this.id);">
                                    <asp:ListItem Text="0" Value="0"></asp:ListItem>
                                </asp:DropDownList>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Item Code">
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hdnListLessDiscount" runat="server" />
                                <asp:HiddenField ID="hdnAfterCoupon" runat="server" />
                                <asp:HiddenField ID="hdnCDAmount" runat="server" />
                                <asp:HiddenField ID="hdnAfterCD" runat="server" />
                                <asp:HiddenField ID="hdnWCAmount" runat="server" />
