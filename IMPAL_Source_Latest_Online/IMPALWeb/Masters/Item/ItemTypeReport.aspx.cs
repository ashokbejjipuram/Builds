...
{
    public partial class ItemTypeReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack && PreviousPage != null)
                {
                    ...
                    crItemType.ReportName = "ItemType";
                    crItemType.RecordSelectionFormula = "";
                    crItemType.GenerateReport();
                    if (crItemType.Visible == false)
                        crItemType.Visible = true;
                }
            }
            catch (Exception exp)
            {
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("ItemType.aspx", false);
