...
{
    public partial class TransactionTypeReport : System.Web.UI.Page
    {
        #region page init
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack && PreviousPage != null)
                {
                    ...
                    crTransactionType.ReportName = "TransactionType";
                    crTransactionType.RecordSelectionFormula = "";
                    crTransactionType.GenerateReport();
                }
            }
            catch (Exception exp)
            {
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("TransactionType.aspx", false);
