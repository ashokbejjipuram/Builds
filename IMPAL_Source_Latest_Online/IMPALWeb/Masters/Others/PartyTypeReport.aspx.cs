...
{
    public partial class PartyTypeReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack && PreviousPage != null)
                {
                    ...
                    crPartyType.ReportName = "PartyType";
                    crPartyType.RecordSelectionFormula = "";
                    crPartyType.GenerateReport();
                }
            }
            catch (Exception exp)
            {
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("PartyType.aspx", false);
