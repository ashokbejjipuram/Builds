...
{
    public partial class DynamicLockingReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack && PreviousPage != null)
                {
                    ...
                    crDynLocking.ReportName = "DynLocking";
                    crDynLocking.RecordSelectionFormula = "";
                    crDynLocking.GenerateReport();
                }
            }
            catch (Exception exp)
            {
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("DynamicLocking.aspx", false);
