...
{
    public partial class BranchTargetReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    crBRTarget.RecordSelectionFormula = "";
                    crBRTarget.GenerateReport();
                }
            }
            catch (Exception exp)
            {
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("BranchTarget.aspx", false);
