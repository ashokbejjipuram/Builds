...
{
    public partial class BRCLReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    crBRClassification.RecordSelectionFormula = "";
                    crBRClassification.GenerateReport();
                }
            }
            catch (Exception exp)
            {
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("BranchClassification.aspx", false);
