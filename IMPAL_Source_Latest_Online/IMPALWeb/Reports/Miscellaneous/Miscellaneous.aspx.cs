    ...
    public partial class Miscellaneous : System.Web.UI.Page
    {
        ...
        protected void LoadReportType()
        {
            ...
            try
            {
                ...
                ddlReportType.DataSource = oCommon.GetDropDownListValues("Miscellaneous-Reports");
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string str_head = "";
                string filename = ddlReportType.SelectedItem.Text + "_" + date1.Replace("/", "") + " to " + date2.Replace("/", "") + ".xls";

                SalesTransactions salesItem = new SalesTransactions();
                ds = salesItem.GetMiscellaneousReportDetails(Session["BranchCode"].ToString(), ddlSupplier.SelectedValue, date1, date2, ddlReportType.SelectedValue);
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("Miscellaneous.aspx", false);
