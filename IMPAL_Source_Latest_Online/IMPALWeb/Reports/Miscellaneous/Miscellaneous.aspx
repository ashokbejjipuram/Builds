<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Miscellaneous.aspx.cs"
    Inherits="IMPALWeb.Reports.Miscellaneous.Miscellaneous" MasterPageFile="~/Main.Master" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidateDatesGST(txtFromDate, txtToDate) {
            ...
            document.getElementById('<%=ddlSupplier.ClientID%>').readOnly = true;
            document.getElementById('<%=txtFromDate.ClientID%>').readOnly = true;
            document.getElementById('<%=txtToDate.ClientID%>').readOnly = true;
            document.getElementById('<%=ddlReportType.ClientID%>').readOnly = true;
        }
    </script>
    ...
    <div class="reportFilters">
        <table id="reportFiltersTable" class="reportFiltersTable" runat="server">
            <tr>
                ...
                <td class="inputcontrols">
                    <asp:DropDownList ID="ddlReportType" runat="server" SkinID="DropDownListNormalBig"
                        TabIndex="3">
                    </asp:DropDownList>
                </td>
            </tr>
