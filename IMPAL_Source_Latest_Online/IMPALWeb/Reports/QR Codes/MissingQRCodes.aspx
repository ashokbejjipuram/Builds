<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="MissingQRCodes.aspx.cs" Inherits="IMPALWeb.Reports.QR_Codes.MissingQRCodes" %>
        ...
        <table id="reportFiltersTable" class="reportFiltersTable" runat="server">
            <tr>
                ...
                <td class="inputcontrols">
                    <asp:DropDownList ID="ddlBranch" runat="server" DataTextField="BranchName" DataValueField="BranchCode" SkinID="DropDownListNormal"  />
                </td>
                <td class="label">
