...
{
    public partial class PurchaseReturnReprintQRDuplicate : System.Web.UI.Page
    {
        ...
        protected void ddlBranch_IndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    fnPopulateInvoicePurchaseReturn();
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DataSet ds = stdnTr.GetEinvoicingDetailsPurchaseReturnOld(ddlBranch.SelectedValue, ddlInvoice.SelectedValue);
                ...
                ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "IMPAL", "alert('QR Code Has been Generated Successfully for Purchase Return Number " + ddlInvoice.SelectedValue + "');", true);
        ...
        protected void fnPopulateInvoicePurchaseReturn()
        {
            Type Source = System.Reflection.MethodBase.GetCurrentMethod().DeclaringType;
            try
            {
                ...
                ddlInvoice.DataSource = stdnTr.GetInvoicePurchaseReturnQR(ddlBranch.SelectedValue);
                ddlInvoice.DataBind();
            }
            catch (Exception exp)
            {
