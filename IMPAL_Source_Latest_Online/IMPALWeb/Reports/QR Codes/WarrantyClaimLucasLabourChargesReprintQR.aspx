<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WarrantyClaimLucasLabourChargesReprintQR.aspx.cs"
    Inherits="IMPALWeb.Reports.QR_Codes.WarrantyClaimLucasLabourChargesReprintQR" %>

<asp:Content ID="ContentWarrantyClaimLucasLabourChargesReprintQR" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="subFormTitle subFormTitleExtender550">
        Warranty Claim Lucas Labour Charges - QR Code
    </div>
