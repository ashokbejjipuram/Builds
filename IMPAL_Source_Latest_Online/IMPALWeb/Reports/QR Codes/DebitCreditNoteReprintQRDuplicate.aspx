<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DebitCreditNoteReprintQRDuplicate.aspx.cs"
    Inherits="IMPALWeb.Reports.QR_Codes.DebitCreditNoteReprintQRDuplicate" %>

<asp:Content ID="ContentDebitCreditNoteReprintQR" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportFormTitle">
        Debit Credit Note QR Code - Duplicate</div>
        ...
        <table id="reportFiltersTable" class="reportFiltersTable" runat="server">
            <tr>
                ...
                <td class="inputcontrols">
                    ...
                    <asp:ListItem Text="Debit Credit Note" Value="S"></asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td class="label">
