<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="STDNinvoiceReprintQR.aspx.cs"
    Inherits="IMPALWeb.Reports.QR_Codes.STDNinvoiceReprintQR" %>
    ...
    <script language="javascript" type="text/javascript">
        function fnValidate() {
            ...
            if (oPONumberVal == null || oPONumberVal == "") {
                alert("STDN Number should not be null");
                ddlPONumber.focus();
                return false;
            }
        }
            ...
            <tr>
                ...
                <td class="inputcontrols">
                    <asp:DropDownList ID="ddlInvoiceType" SkinID="DropDownListNormal" TabIndex="1" runat="server">
                        <asp:ListItem Text="STDN Invoice" Value="I"></asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td class="label">
                    <asp:Label ID="lblInvoiceSTDN" SkinID="LabelNormal" Text="STDN Number" runat="server"></asp:Label><span
                        class="asterix">*</span>
                </td>
                <td class="inputcontrols">
