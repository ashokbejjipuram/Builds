...
{
    public partial class WarrantyClaimLucasLabourChargesReprintQRDuplicate : System.Web.UI.Page
    {
        ...
        protected void ddlBranch_IndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    fnPopulateInvoiceWarrantyClaimLucasLabourCharges();
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DataSet ds = stdnTr.GetEinvoicingDetailsWarrantyClaimLucasHandlingLabourChargesOld(ddlBranch.SelectedValue, ddlInvoice.SelectedValue);
                ...
                ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "IMPAL", "alert('QR Code Has been Generated Successfully for Warranty Claim Labour Charges Number " + ddlInvoice.SelectedValue + "');", true);
        ...
        protected void fnPopulateInvoiceWarrantyClaimLucasLabourCharges()
        {
            Type Source = System.Reflection.MethodBase.GetCurrentMethod().DeclaringType;
            try
            {
                ...
                ddlInvoice.DataSource = stdnTr.GetInvoiceWarrantyClaimLucasLabourChargesQR(ddlBranch.SelectedValue);
                ddlInvoice.DataBind();
            }
            catch (Exception exp)
            {
