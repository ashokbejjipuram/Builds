<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="STDNinvoiceReprintQRDuplicate.aspx.cs"
    Inherits="IMPALWeb.Reports.QR_Codes.STDNinvoiceReprintQRDuplicate" %>
...
<asp:Content ID="ContentSalesInvoiceReprint" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportFormTitle">
        STDN Invoice QR Code - Duplicate
    </div>
