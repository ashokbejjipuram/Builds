...
{
    public partial class MissingQRCodes : System.Web.UI.Page
    {
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ds = salesItem.GetMissingQRCodeDocs(ddlBranch.SelectedValue, date1, date2);
                string filename = "Missing_QR_Codes_" + txtFromDate.Text.Replace("/","") + ".xls";
