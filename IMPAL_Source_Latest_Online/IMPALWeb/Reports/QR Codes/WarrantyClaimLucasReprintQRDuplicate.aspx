<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WarrantyClaimLucasReprintQRDuplicate.aspx.cs"
    Inherits="IMPALWeb.Reports.QR_Codes.WarrantyClaimLucasReprintQRDuplicate" %>

<asp:Content ID="ContentWarrantyClaimLucasReprintQRDuplicate" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="subFormTitle subFormTitleExtender550">
        Warranty Claim Lucas QR Code - Duplicate
    </div>
