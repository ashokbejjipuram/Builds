<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="SalesInvoiceReprintQR.aspx.cs"
    Inherits="IMPALWeb.Reports.QR_Codes.SalesInvoiceReprintQR" %>
            ...
            <tr>
                ...
                <td class="inputcontrols">
                    <asp:DropDownList ID="ddlInvoiceType" SkinID="DropDownListNormal" TabIndex="1" runat="server">
                        <asp:ListItem Text="Sales Invoice" Value="D"></asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td class="label">
                    <asp:Label ID="lblInvoice" SkinID="LabelNormal" Text="Invoice Number" runat="server"></asp:Label><span
                        class="asterix">*</span>
                </td>
                <td class="inputcontrols">
