...
{
    public partial class SalesInvoiceReprintQRDuplicate : System.Web.UI.Page
    {
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataSet ds = srpt.GetEinvoicingDetailsOldQR(ddlBranch.SelectedValue, GSTINStatus[0].ToString(), ddlInvoiceType.SelectedValue);

                GenerateJSON objGenJsonData = new GenerateJSON();

                if (GSTINStatus[1].ToString().Contains("UNREG"))
                {
                    einvGen.EinvoiceAuthenticationB2C(objGenJsonData.GenerateInvoiceJSONDataB2C(ds, ddlBranch.SelectedValue), ddlBranch.SelectedValue, GSTINStatus[0].ToString(), "1", "NOIRN");
                ...
                else
                {
                    ...
                    einvGen.EinvoiceAuthentication(JSONData, ddlBranch.SelectedValue, GSTINStatus[0].ToString(), "1", "GETIRN", ds.Tables[0].Rows[0]["Supplier_GSTIN"].ToString(), ds.Tables[0].Rows[0]["Document_Type"].ToString(), ds.Tables[0].Rows[0]["Document_Date"].ToString().Replace("-", "/"), ds);
