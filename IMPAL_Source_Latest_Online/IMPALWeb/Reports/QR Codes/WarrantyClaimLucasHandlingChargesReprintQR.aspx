<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WarrantyClaimLucasHandlingChargesReprintQR.aspx.cs"
    Inherits="IMPALWeb.Reports.QR_Codes.WarrantyClaimLucasHandlingChargesReprintQR" %>

<asp:Content ID="ContentWarrantyClaimLucasHandlingChargesReprintQR" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="subFormTitle subFormTitleExtender550">
        Warranty Claim Lucas Handling Charges - QR Code
    </div>
