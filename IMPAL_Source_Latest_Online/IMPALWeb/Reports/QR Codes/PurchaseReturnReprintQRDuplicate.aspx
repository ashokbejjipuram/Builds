<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PurchaseReturnReprintQRDuplicate.aspx.cs"
    Inherits="IMPALWeb.Reports.QR_Codes.PurchaseReturnReprintQRDuplicate" %>

<asp:Content ID="ContentPurchaseReturnReprintQR" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportFormTitle">
        Purchase Return QR Code - Duplicate
    </div>
            ...
            <tr>
                ...
                <td class="inputcontrols">
                    <asp:DropDownList ID="ddlInvoiceType" SkinID="DropDownListNormal" TabIndex="1" runat="server">
                        <asp:ListItem Text="Purchase Return" Value="P"></asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td class="label">
