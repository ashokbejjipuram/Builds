<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WarrantyClaimLucasHandlingChargesReprintQRDuplicate.aspx.cs"
    Inherits="IMPALWeb.Reports.QR_Codes.WarrantyClaimLucasHandlingChargesReprintQRDuplicate" %>

<asp:Content ID="ContentWarrantyClaimLucasHandlingChargesReprintQRDuplicate" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="subFormTitle subFormTitleExtender550">
        Warranty Claim Lucas Handling Charges QR Code - Duplicate
    </div>
