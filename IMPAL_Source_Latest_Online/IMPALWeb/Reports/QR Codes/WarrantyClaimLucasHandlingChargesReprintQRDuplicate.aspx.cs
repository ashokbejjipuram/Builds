...
{
    public partial class WarrantyClaimLucasHandlingChargesReprintQRDuplicate : System.Web.UI.Page
    {
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "IMPAL", "alert('QR Code Has been Generated Successfully for Warranty Claim Handling Charges Number " + ddlInvoice.SelectedValue + "');", true);
