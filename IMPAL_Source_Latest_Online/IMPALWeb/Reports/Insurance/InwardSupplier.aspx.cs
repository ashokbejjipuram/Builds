...
{
    public partial class InwardSupplier : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (crInwardSupplier != null)
                    {
                        crInwardSupplier.Dispose();
                        crInwardSupplier = null;
                    }
                }
        ...
        protected void crInwardSupplier_Unload(object sender, EventArgs e)
        {
            if (crInwardSupplier != null)
            {
                crInwardSupplier.Dispose();
        ...
        public void GenerateSelectionFormula()
        {
            ...
            try
            {
                ...
                #endregion
                crInwardSupplier.ReportName = strReportName;
                crInwardSupplier.RecordSelectionFormula = strSelectionFormula;
                crInwardSupplier.GenerateReport();
            }
            catch (Exception exp)
            {
                Log.WriteException(Source, exp);
