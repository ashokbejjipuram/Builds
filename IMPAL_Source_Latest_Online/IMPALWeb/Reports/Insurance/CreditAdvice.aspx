<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CreditAdvice.aspx.cs"
    Inherits="IMPALWeb.Reports.Insurance.CreditAdvice" %>
...
<asp:Content ID="CPHDetails" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <UC:CrystalReport runat="server" ID="crCreditAdvice" OnUnload="crCreditAdvice_Unload" ReportName="CreditAdvice" />
    </div>
</asp:Content>
