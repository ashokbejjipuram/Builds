<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="InwardSupplier.aspx.cs"
    Inherits="IMPALWeb.Reports.Insurance.InwardSupplier" %>
...
<asp:Content ID="CPHDetails" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportFormTitle reportFormTitleExtender350">
        Inward -Supplierwise Pending Statement</div>
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <UC:CrystalReport runat="server" ID="crInwardSupplier" OnUnload="crInwardSupplier_Unload" ReportName="InwardSupplier" />
    </div>
</asp:Content>
