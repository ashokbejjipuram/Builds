...
{
    public partial class CreditAdvice : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (crCreditAdvice != null)
                    {
                        crCreditAdvice.Dispose();
                        crCreditAdvice = null;
                    }
                }
            }
        ...
        protected void crCreditAdvice_Unload(object sender, EventArgs e)
        {
            if (crCreditAdvice != null)
            {
                crCreditAdvice.Dispose();
        ...
        public void GenerateSelectionFormula()
        {
            ...
            try
            {
                ...
                #endregion
                crCreditAdvice.ReportName = strReportName;
                crCreditAdvice.RecordSelectionFormula = strSelectionFormula;
                crCreditAdvice.GenerateReport();
            }
            catch (Exception exp)
            {
                Log.WriteException(Source, exp);
