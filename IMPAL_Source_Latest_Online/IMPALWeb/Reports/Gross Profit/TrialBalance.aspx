<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="TrialBalance.aspx.cs"
    Inherits="IMPALWeb.Reports.Gross_Profit.TrialBalance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <UC:CrystalReport ID="crTrialBal_Branch" runat="server" OnUnload="crTrialBal_Branch_Unload" ReportName="TrialBal_Branch" />
    </div>
</asp:Content>
