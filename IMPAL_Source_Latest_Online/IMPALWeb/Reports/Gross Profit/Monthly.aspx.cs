    ...
    public partial class Monthly : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    if (crMonthly_BrGP != null)
                    {
                        crMonthly_BrGP.Dispose();
                        crMonthly_BrGP = null;
                    }
        ...
        protected void crMonthly_BrGP_Unload(object sender, EventArgs e)
        {
            if (crMonthly_BrGP != null)
            {
                crMonthly_BrGP.Dispose();
        ...
        public void GenerateSelectionFormula()
        {
            ...
            crMonthly_BrGP.CrystalFormulaFields.Add("AccDesc", "\"" + strDesc + "\"");
            crMonthly_BrGP.RecordSelectionFormula = strSelectionFormula;
            crMonthly_BrGP.GenerateReport();
            }
            catch (Exception exp)
            {
                Log.WriteException(Source, exp);
