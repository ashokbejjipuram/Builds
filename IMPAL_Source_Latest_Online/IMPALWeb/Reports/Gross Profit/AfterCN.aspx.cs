...
{
    public partial class AfterCN : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    if (crAfterCn_Branch != null)
                    {
                        crAfterCn_Branch.Dispose();
                        crAfterCn_Branch = null;
                    }
        ...
        protected void crAfterCn_Branch_Unload(object sender, EventArgs e)
        {
            if (crAfterCn_Branch != null)
            {
                crAfterCn_Branch.Dispose();
        ...
        public void GenerateSelectionFormula()
        {
            ...
            strGPBrcode = "{gponnet.brcode}";
            strGPMonyr = "{gponnet.month_year}";
            ...
            DbCommand dbcmd = ImpalDB.GetStoredProcCommand("usp_gponnet");
            ...
            crAfterCn_Branch.RecordSelectionFormula = strSelectionFormula;
            crAfterCn_Branch.GenerateReport();
            }
            catch (Exception exp)
            {
                Log.WriteException(Source, exp);
            ...
            try
            {
                ...
                if (btnReport.Text == "Back")
                {
                    if (ddlBSZ.SelectedValue == "Branch")
                        ...
                        crAfterCn_Branch.ReportName = "AfterCn_State";
                    else if (ddlBSZ.SelectedValue == "Zone")
                        crAfterCn_Branch.ReportName = "AfterCn_Zone";
