...
{
    public partial class AnnualManager : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    if (crAnnualManager != null)
                    {
                        crAnnualManager.Dispose();
                        crAnnualManager = null;
                    }
        ...
        protected void crAnnualManager_Unload(object sender, EventArgs e)
        {
            if (crAnnualManager != null)
            {
                crAnnualManager.Dispose();
        ...
        private void fnPopulateBranches()
        {
            Type Source = System.Reflection.MethodBase.GetCurrentMethod().DeclaringType;
            try
            {
                Branches Br = new Branches();
                ddlBranch.DataSource = Br.GetAllLinewiseBranches(null, null, sessionbrchcode);
            ...
            try
            {
                ...
                if (btnReport.Text == "Back")
                {
                    ...
                    if (sessionbrchcode != "CRP")
                    {
                        ...
                        {
                            if (ddlBranch.SelectedIndex == 0 && ddlAreaManager.SelectedIndex == 0)
                            {
                                selectionformula = strsel1 + "'" + date1 + "' and " + strsel3 + "'" + sessionbrchcode + "'";
                            }
                            else if (ddlAreaManager.SelectedIndex == 0 && ddlBranch.SelectedIndex != 0)
                            {
                    ...
                    else
                    {
                        ...
                        else if (date1 != "0" && date2 != "0" && date3 == "0")
                        {
                            ...
                            {
                                selectionformula = "(" + strsel1 + "'" + date1 + "' or " + strsel1 + "'" + date2 + "' ) and " + strsel3 + "'" + ddlBranch.SelectedValue + "'";
                            }
                            else if (ddlAreaManager.SelectedIndex != 0 && ddlBranch.SelectedIndex != 0)
                            {
                                selectionformula = "(" + strsel1 + "'" + date1 + "' or " + strsel1 + "'" + date2 + "') and " + strsel3 + "'" + ddlBranch.SelectedValue + "' and " + strsel2 + "'" + ddlAreaManager.SelectedValue + "'";
                            }
                            else if (ddlAreaManager.SelectedIndex != 0 && ddlBranch.SelectedIndex == 0)
                            {
                        ...
                        else if (date1 != "0" && date2 == "0" && date3 == "0")
                        {
                            ...
                            {
                                selectionformula = strsel1 + "'" + date1 + "' and " + strsel3 + "'" + ddlBranch.SelectedValue + "'";
                            }
                            else if (ddlAreaManager.SelectedIndex != 0 && ddlBranch.SelectedIndex != 0)
                            {
                                selectionformula = strsel1 + "'" + date1 + "' and " + strsel3 + "'" + ddlBranch.SelectedValue + "' and " + strsel2 + "'" + ddlAreaManager.SelectedValue + "'";
                            }
                            else if (ddlAreaManager.SelectedIndex != 0 && ddlBranch.SelectedIndex == 0)
                            {
                    ...
                    crAnnualManager.RecordSelectionFormula = selectionformula;
                    crAnnualManager.ReportName = "impal-Reports-Areamanagerstock";
                    crAnnualManager.GenerateReport();
                }
            }
            catch (Exception exp)
            {
