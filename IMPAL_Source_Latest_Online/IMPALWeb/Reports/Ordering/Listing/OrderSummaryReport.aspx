<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="OrderSummaryReport.aspx.cs"
    Inherits="IMPALWeb.Reports.Ordering.Listing.OrderSummary" %>
    ...
    <div class="reportFilters">
        ...
        <div class="reportButtons">
            <asp:Button ID="btnReport" runat="server" Text="Generate Report" OnClientClick="javaScript:return fnValidate();"
                TabIndex="5" SkinID="ButtonViewReport" OnClick="btnReport_Click" />
        </div>
    </div>
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc1:CrystalReport runat="server" ID="crOrderSummary" OnUnload="crOrderSummary_Unload" ReportName="OrderSummary" />
    </div>
</asp:Content>
