<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ZBLOrderInflow.aspx.cs"
    Inherits="IMPALWeb.Reports.Ordering.Listing.ZBLOrderInflow" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportFormTitle reportFormTitleExtender300">
        Zone/Branch/Line Order Inflow Statement</div>
    <div class="reportFilters">
        ...
        <div class="reportButtons">
            <asp:Button ID="btnReport" runat="server" Text="Generate Report" SkinID="ButtonViewReport"
                OnClientClick="javaScript:return fnValidate();" TabIndex="3" OnClick="btnReport_Click" />
        </div>
    </div>
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <UC:CrystalReport ID="crZBLOrderInflow" runat="server" OnUnload="crZBLOrderInflow_Unload" ReportName="ZBLOrderInflow" />
    </div>
</asp:Content>
