<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PendingSTDNs.aspx.cs"
    Inherits="IMPALWeb.Reports.Ordering.Listing.PendingSTDNs" MasterPageFile="~/Main.Master" %>
    ...
    <asp:UpdatePanel ID="upHeader" runat="server" UpdateMode="Conditional">
        ...
        <ContentTemplate>
                        ...
                        <tr>
                            <td class="label">
                                ...
                                <td class="inputcontrols">
                                    <asp:DropDownList ID="ddlOrdBranchName" runat="server" SkinID="DropDownListNormal" />
                                </td>
                            <td class="label">
            ...
            <div class="reportButtons">
                <asp:Button ID="btnReportExcel" runat="server" Text="Download Excel" TabIndex="4" SkinID="ButtonViewReport"
