<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CustomerPOList.aspx.cs"
    Inherits="IMPALWeb.Reports.Ordering.Listing.CustomerPOList" %>
...
<asp:Content ID="CPHDetails" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc1:CrystalReport runat="server" ID="crCustomerPO" OnUnload="crCustomerPO_Unload" ReportName="CustomerPOList" />
    </div>
</asp:Content>
