<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DatewisePurchaseOrder.aspx.cs"
    Inherits="IMPALWeb.Reports.Ordering.Listing.DatewisePurchaseOrderReport" %>
...
<asp:Content ID="CPHDetails" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportFilters">
        ...
        <div class="reportButtons">
            <asp:Button ID="btnReport" runat="server" Text="Generate Report" TabIndex="5" SkinID="ButtonViewReport"
                OnClientClick="javaScript:return fnValidate();" OnClick="btnReport_Click" />
        </div>
    </div>
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <UC:CrystalReport runat="server" ID="crDatewisePurchaseOrder" OnUnload="crDatewisePurchaseOrder_Unload" ReportName="DatewisePurchaseOrder" />
    </div>
</asp:Content>
