...
{
    public partial class LinewisePurchaseOrder : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (crLinewisePurchaseOrder != null)
                    {
                        crLinewisePurchaseOrder.Dispose();
                        crLinewisePurchaseOrder = null;
                    }
                }
        ...
        protected void crLinewisePurchaseOrder_Unload(object sender, EventArgs e)
        {
            if (crLinewisePurchaseOrder != null)
            {
                crLinewisePurchaseOrder.Dispose();
        ...
        public void GenerateSelectionFormula()
        {
            ...
            try
            {
                ...
                strReportName = "LinewisePurchaseOrder";
                ...
                crLinewisePurchaseOrder.ReportName = strReportName;
                crLinewisePurchaseOrder.CrystalFormulaFields.Add("From_Date", "'" + txtFromDate.Text + "'");
                crLinewisePurchaseOrder.CrystalFormulaFields.Add("To_Date", "'" + txtToDate.Text + "'");
                crLinewisePurchaseOrder.RecordSelectionFormula = strSelectionFormula;
                crLinewisePurchaseOrder.GenerateReport();
            }
            catch (Exception exp)
            {
                Log.WriteException(Source, exp);
