...
{
    public partial class Quarterly_Comparison_Branch_Line : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    if (crbranchline != null)
                    {
                        crbranchline.Dispose();
                        crbranchline = null;
                    }
        ...
        protected void crbranchline_Unload(object sender, EventArgs e)
        {
            if (crbranchline != null)
            {
                crbranchline.Dispose();
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (btnReport.Text == "Back")
                {
                    ...
                    crbranchline.RecordSelectionFormula = selectionformula;
                    crbranchline.ReportName = "Impal_QtrOOOHbranch";
                    crbranchline.GenerateReport();
                }
            }
            catch (Exception exp)
            {
