<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="CreditNote.aspx.cs"
    Inherits="IMPALWeb.Reports.Sales.SalesStatement.CreditNote" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <asp:UpdatePanel ID="upHeader" runat="server" UpdateMode="Conditional">
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="crSalesCreditNote" />
        </Triggers>
        <ContentTemplate>
            <asp:Panel ID="PanelHeaderDtls" runat="server">
                <div class="reportFilters">
                    <table id="reportFiltersTable" class="reportFiltersTable" runat="server">
                        <tr>
                            <td class="label">
                                <asp:Label ID="lblFromDate" runat="server" Text="From Document Date" SkinID="LabelNormal"></asp:Label><span
                                    class="asterix">*</span>
                            </td>
                            ...
                            <td class="label">
                                <asp:Label ID="lblToDate" runat="server" Text="To Document Date" SkinID="LabelNormal"></asp:Label><span
                                    class="asterix">*</span>
                            </td>
                            <td class="inputcontrols">
            ...
            <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
                <uc:CrystalReport ID="crSalesCreditNote" runat="server" OnUnload="crSalesCreditNote_Unload" ReportName="CreditNote" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
