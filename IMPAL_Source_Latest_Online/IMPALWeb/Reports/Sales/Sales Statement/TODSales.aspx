<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TODSales.aspx.cs" MasterPageFile="~/Main.Master"
    Inherits="IMPALWeb.Reports.Sales.SalesStatement.TODSales" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="CPHDetails" runat="server">
                ...
                <td>
                    <table id="reportFiltersTable1" class="reportFiltersTable" runat="server">
                        <tr>
                            ...
                            <td class="label">
                                <asp:Label ID="lblPlant" runat="server" Text="Plant" SkinID="LabelNormal"></asp:Label>
                            </td>
                            <td class="inputcontrols">
                                <asp:DropDownList ID="ddlPlant" runat="server" SkinID="DropDownListNormal" TabIndex="2">
                                </asp:DropDownList>
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc:CrystalReport ID="crTOD" runat="server" OnUnload="crstocklist_Unload" />
    </div>
</asp:Content>
