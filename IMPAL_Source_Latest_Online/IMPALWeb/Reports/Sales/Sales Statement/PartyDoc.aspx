<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="PartyDoc.aspx.cs"
    Inherits="IMPALWeb.Reports.Sales.SalesStatement.PartyDoc" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc:CrystalReport ID="crSalesPartyDocument" runat="server" OnUnload="crSalesPartyDocument_Unload" ReportName="PartyDoc" />
    </div>
</asp:Content>
