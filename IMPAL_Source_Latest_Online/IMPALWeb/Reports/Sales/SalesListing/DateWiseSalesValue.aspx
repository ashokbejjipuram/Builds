<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DateWiseSalesValue.aspx.cs"
    Inherits="IMPALWeb.Reports.Sales.SalesListing.DateWiseSalesValue" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc1:CrystalReport runat="server" ID="cryDateWiseSalesValue" OnUnload="cryDateWiseSalesValue_Unload" />
    </div>
</asp:Content>
