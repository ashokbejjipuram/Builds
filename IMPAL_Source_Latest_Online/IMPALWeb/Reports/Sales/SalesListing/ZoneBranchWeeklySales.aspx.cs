...
{
    public partial class ZoneBranchWeeklySales : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (cryZoneBranchWeeklyStatus != null)
                {
                    cryZoneBranchWeeklyStatus.Dispose();
                    cryZoneBranchWeeklyStatus = null;
                }
        ...
        protected void cryZoneBranchWeeklyStatus_Unload(object sender, EventArgs e)
        {
            if (cryZoneBranchWeeklyStatus != null)
            {
                cryZoneBranchWeeklyStatus.Dispose();
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (btnReport.Text == "Back")
                {
                    ...
                    strReportName = "ZoneBranchWeeklySales";
                    ...
                    cryZoneBranchWeeklyStatus.ReportName = strReportName;
                    cryZoneBranchWeeklyStatus.CrystalFormulaFields.Add("From_Date", "'" + txtFromDate.Text + "'");
                    cryZoneBranchWeeklyStatus.CrystalFormulaFields.Add("To_Date", "'" + txtToDate.Text + "'");
                    cryZoneBranchWeeklyStatus.RecordSelectionFormula = strSelectionFormula;
                    cryZoneBranchWeeklyStatus.GenerateReport();
                }
            }
            catch (Exception exp)
            {
