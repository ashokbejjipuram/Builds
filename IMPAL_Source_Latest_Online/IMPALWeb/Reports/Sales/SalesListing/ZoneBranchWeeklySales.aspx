<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ZoneBranchWeeklySales.aspx.cs"
    Inherits="IMPALWeb.Reports.Sales.SalesListing.ZoneBranchWeeklySales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc1:CrystalReport runat="server" ID="cryZoneBranchWeeklyStatus" OnUnload="cryZoneBranchWeeklyStatus_Unload" />
    </div>
</asp:Content>
