<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="STDNInwardOutward.aspx.cs"
    Inherits="IMPALWeb.Reports.Sales.SalesListing.SalesListing_item_wise_" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportFormTitle reportFormTitleExtender350">
        STDN Inward/Outward(Invoice/PartNo)
    </div>
    <asp:UpdatePanel ID="upHeader" runat="server" UpdateMode="Conditional">
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="crSTDN_Inward" />
        </Triggers>
        <ContentTemplate>
            ...
            <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
                <UC:CrystalReport ID="crSTDN_Inward" runat="server" OnUnload="crSTDN_Inward_Unload" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
