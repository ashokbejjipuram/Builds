<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="STU_Linewise.aspx.cs" Inherits="IMPALWeb.Reports.Sales.Sales_Comparison.STU_Linewise" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportFormTitle reportFormTitleExtender350">
        STU Sales Comparison Line Number Wise
    </div>
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc1:CrystalReport runat="server" ID="crstulinewise" OnUnload="crstulinewise_Unload" />
    </div>
</asp:Content>
