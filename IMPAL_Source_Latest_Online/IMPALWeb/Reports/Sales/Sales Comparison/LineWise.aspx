<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="LineWise.aspx.cs" Inherits="IMPALWeb.Reports.Sales.Sales_Comparison.LineWise" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <script type="text/javascript">      function Validatenull() {
        ...
        <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
            <uc1:CrystalReport runat="server" ID="crlinewise" OnUnload="crlinewise_Unload" />
        </div>
</asp:Content>
