<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TownWise.aspx.cs" Inherits="IMPALWeb.Reports.Sales.SalesAnalysis.TownWise"
...
<asp:Content ID="MainContent" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <asp:UpdatePanel ID="upHeader" runat="server" UpdateMode="Conditional">
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="crTownWise" />
        </Triggers>
        <ContentTemplate>
            ...
            <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
                <UC:CrystalReport ID="crTownWise" runat="server" OnUnload="crTownWise_Unload" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
