...
{
    public partial class GSTInwardRegister : System.Web.UI.Page
    {
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ds = salesItem.GetGSTInwardRegisterDetails(Session["BranchCode"].ToString(), date1, date2);
                ...
                string filename = ds.Tables[1].Rows[0]["GSTIN"].ToString() + "_" + ds.Tables[1].Rows[0]["Branch_Code"].ToString() + "_IW_" + ds.Tables[1].Rows[0]["MonthYear"].ToString() + ".xls";
