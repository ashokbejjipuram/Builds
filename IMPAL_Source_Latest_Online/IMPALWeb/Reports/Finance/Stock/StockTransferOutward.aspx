<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="StockTransferOutward.aspx.cs"
    Inherits="IMPALWeb.Reports.Finance.Stock.StockTransferOutward" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportFormTitle reportFormTitleExtender350">
        Stock Transfer Outward Journal
    </div>
    <asp:UpdatePanel ID="upHeader" runat="server" UpdateMode="Conditional">
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="crstocktransferoutward_Detail" />
        </Triggers>
        <ContentTemplate>
                ...
                <div class="reportFilters">
                    <table id="reportFiltersTable" class="reportFiltersTable" runat="server">
                        <tr>
                            ...
                            <td class="inputcontrols">
                                <asp:DropDownList ID="ddlReportType" runat="server" AutoPostBack="true" SkinID="DropDownListNormal"
                                    OnSelectedIndexChanged="ddlReportType_OnSelectedIndexChanged" TabIndex="3">
                                </asp:DropDownList>
                            </td>
                        </tr>
                    </table>
            ...
            <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
                <UC:CrystalReport ID="crstocktransferoutward_Detail" runat="server" ReportName="stocktransferoutward_Detail" OnUnload="crstocktransferoutward_Detail_Unload" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
