<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="GoodsClearedStatement.aspx.cs"
    Inherits="IMPALWeb.Reports.Finance.Stock.GoodsClearedStatement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportFormTitle reportFormTitleExtender350">
        Goods Cleared/Un-Cleared Statement
    </div>
    <asp:UpdatePanel ID="upHeader" runat="server" UpdateMode="Conditional">
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="crGoodClearedStatement" />
        </Triggers>
        <ContentTemplate>
                ...
                <div class="reportFilters">
                    <table id="reportFiltersTable" class="reportFiltersTable" runat="server">
                        <tr>
                            ...
                            <td class="label">
                                <asp:Label ID="lblStatement" runat="server" Text="Report Type" SkinID="LabelNormal"></asp:Label>
                            </td>
                            <td class="inputcontrols">
            ...
            <div class="reportButtons">
                <asp:Button ID="btnReport" runat="server" Text="Generate Report" TabIndex="5" OnClientClick="javaScript:return fnValidate();"
            ...
            <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
                <UC:CrystalReport ID="crGoodClearedStatement" runat="server" ReportName="GoodClearedStatement" OnUnload="crGoodClearedStatement_Unload" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
