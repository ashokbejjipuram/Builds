<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="StockTransferInward.aspx.cs"
    Inherits="IMPALWeb.Reports.Finance.Stock.StockTransferInward" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <asp:UpdatePanel ID="upHeader" runat="server" UpdateMode="Conditional">
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="crstocktransferinward_Detail" />
        </Triggers>
        <ContentTemplate>
            ...
            <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
                <UC:CrystalReport ID="crstocktransferinward_Detail" runat="server" ReportName="stocktransferinward_Detail" OnUnload="crstocktransferinward_Detail_Unload" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
