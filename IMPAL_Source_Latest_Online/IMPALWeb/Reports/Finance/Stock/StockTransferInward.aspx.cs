...
{
    public partial class StockTransferInward : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {  
                    if (crstocktransferinward_Detail != null)
                    {
                        crstocktransferinward_Detail.Dispose();
                        crstocktransferinward_Detail = null;
                    }
        ...
        protected void crstocktransferinward_Detail_Unload(object sender, EventArgs e)
        {
            if (crstocktransferinward_Detail != null)
            {
                crstocktransferinward_Detail.Dispose();
        ...
        protected void btnReportPDF_Click(object sender, EventArgs e)
        {
            ...
            else if (ddlReportType.SelectedValue == "Summary")
            {
                ...
                ds = cbtrans.GetSTDNInwardOutwardJournalDetails(strBranchCode, txtFromDate.Text, txtToDate.Text, "I");
                ...
                string heading = strBranchName + " - Stock Inward Journal Summary for the Period " + string.Format("{0:dd/MM/yyyy}", txtFromDate.Text) + " - " + string.Format("{0:dd/MM/yyyy}", txtToDate.Text);
                ...
                Response.AddHeader("Content-Disposition", "attachment; filename=" + strBranchCode + "_StockInwardJournalSummary_" + DateTime.Now.ToString("ddMMyyyy_hhmmsstt") + ".pdf");
                Response.Clear();
        ...
        protected void btnReportExcel_Click(object sender, EventArgs e)
        {
            ...
            else if (ddlReportType.SelectedValue == "Summary")
            {
                ...
                try
                {
                    ...
                    string str_head = "";
                    string filename = "StockInwardJournalSummary_" + txtFromDate.Text.Replace("/", "") + "_" + DateTime.Now.ToString("hhmmsstt") + ".xls";

                    CashAndBankTransactions cbtrans = new CashAndBankTransactions();

                    ds = cbtrans.GetSTDNInwardOutwardJournalDetails(strBranchCode, strFromDate, strToDate, "I");
                    string strBranchName = (string)Session["BranchName"];
                    str_head = "<center><b><font size='6'>Stock Inward Journal Summary for the Period " + string.Format("{0:dd/MM/yyyy}", strFromDate) + " - " + string.Format("{0:dd/MM/yyyy}", strToDate) + "</font></b><br><br></center>";
        ...
        public void GenerateAndExportReport(string fileType)
        {
            ...
            if (ddlReportType.SelectedValue == "Detail")
                crstocktransferinward_Detail.ReportName = "stocktransferinward_Detail";
            ...
            strSelectionFormula = strSelectionFormula + " and {STDN_Header.To_Branch_code}={STDN_Header.Branch_code}";

            crstocktransferinward_Detail.CrystalFormulaFields.Add("From_Date", "'" + txtFromDate.Text + "'");
            crstocktransferinward_Detail.CrystalFormulaFields.Add("To_Date", "'" + txtToDate.Text + "'");
            crstocktransferinward_Detail.RecordSelectionFormula = strSelectionFormula;
            crstocktransferinward_Detail.GenerateReportAndExport(fileType);
        }
        #endregion
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("StockTransferInward.aspx", false);
