<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PurchaseJournal.aspx.cs"
    Inherits="IMPALWeb.Reports.Finance.Accounts_Payable.PurchaseJournal" %>
...
<asp:Content ID="CPHDetails" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidateDatesGST(txtFromDate, txtToDate) {
            ...
            if (oFromDateVal == null || oFromDateVal == "") {
                ...
                alert("From Date should be less than or equal to 30th June 2017");
                txtFromDate.value = "";
                txtFromDate.focus();
                return false;
            }
            else if (new Date(oToDateFormatted) > new Date('6/30/2017')) {
                alert("To Date should be less than or equal to 30th June 2017");
                txtToDate.value = "";
                txtToDate.focus();
                return false;
            }
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <UC:CrystalReport runat="server" ID="crPurchaseJournal" ReportName="PurchaseJournal" OnUnload="crPurchaseJournal_Unload" />
    </div>
</asp:Content>
