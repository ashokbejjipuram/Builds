<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BMSPaymentAdviceReport.aspx.cs"
    Inherits="IMPALWeb.Reports.Finance.Accounts_Payable.BMSPaymentAdviceReport" %>

<%@ Register Src="~/UserControls/CrystalReport.ascx" TagName="CrystalReport" TagPrefix="uc1" %>
<asp:Content ID="ContentBMSPaymentAdviceReport" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc1:CrystalReport ID="crBMSPaymentAdviceReport" runat="server" OnUnload="crBMSPaymentAdviceReport_Unload" />
    </div>
</asp:Content>
