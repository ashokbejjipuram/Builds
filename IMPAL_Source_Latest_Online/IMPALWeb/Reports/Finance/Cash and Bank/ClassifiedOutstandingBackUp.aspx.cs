...
{
    public partial class ClassifiedOutstandingBackUp : System.Web.UI.Page
    {
        ...
        public void fnPopulateCustInfo(string strCustomerCode)
        {
            Type Source = System.Reflection.MethodBase.GetCurrentMethod().DeclaringType;
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(strCustomerCode))
                {
                    ...
                    sSQL = "select status ,address1,address2,address3,address4,location from customer_master WITH (NOLOCK) where customer_code ='" + strCustomerCode + "'";
        ...
        protected void cboFromCustomer_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                CustInfo.Visible = true;
                fnPopulateCustInfo(cboToCustomer.SelectedValue);
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ds = outStanding.GetOutstandingDetailsBackUp(Session["BranchCode"].ToString(), cboFromCustomer.SelectedValue, cboToCustomer.SelectedValue, txtDate.Text);
