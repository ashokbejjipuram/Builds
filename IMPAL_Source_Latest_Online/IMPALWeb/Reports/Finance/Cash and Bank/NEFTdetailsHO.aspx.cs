...
{
    public partial class NEFTdetailsHO : System.Web.UI.Page
    {
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ds = cbItem.GetNEFTdetailsHO(Session["BranchCode"].ToString(), date1, date2);
                string strBranchName = (string)Session["BranchName"];

                string filename = "NEFT_Details_" + date1.Replace("/","") + "-" + date2.Replace("/", "") + ".xls";
