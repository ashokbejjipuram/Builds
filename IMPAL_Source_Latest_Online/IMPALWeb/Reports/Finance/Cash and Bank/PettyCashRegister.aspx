<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PettyCashRegister.aspx.cs"
    Inherits="IMPALWeb.Reports.Finance.Cash_and_Bank.PettyCashRegister" %>
...
<asp:Content ID="CPHDetails" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc1:CrystalReport runat="server" ID="crPettyCash" OnUnload="crPettyCash_Unload" ReportName="PettyCashReport" />
    </div>
</asp:Content>
