...
{
    public partial class PDCRegisterReport : System.Web.UI.Page
    {
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                CashAndBankTransactions cbItem = new CashAndBankTransactions();
                ds = cbItem.GetPDCRegisterReport(ddlBranch.SelectedValue, date1, date2);
                string strBranchName = (string)Session["BranchName"];                

                string filename = "PDC_Register" + "_" + DateTime.Now.ToString("yyyyMMdd") + "_" + DateTime.Now.ToString("HHmmssfff") + ".xls";
