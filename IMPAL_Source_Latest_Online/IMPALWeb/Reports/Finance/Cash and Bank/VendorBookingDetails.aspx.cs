...
{
    public partial class VendorBookingDetails : System.Web.UI.Page
    {
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string str_head = "";
                btnReport.Text = "Back";
                string filename = "VendorBookingDetails_" + string.Format("{0:dd/MM/yyyy}", strFromDate) + " to " + string.Format("{0:dd/MM/yyyy}", strToDate) + ".xls";

                CashAndBankTransactions cbtrans = new CashAndBankTransactions();

                ds = cbtrans.GetVendorBookingDetails(Session["BranchCode"].ToString(), strFromDate, strToDate);
                string strBranchName = (string)Session["BranchName"];
                str_head = "<center><b><font size='6'>Vendor Booking Details From " + string.Format("{0:dd/MM/yyyy}", strFromDate) + " To " + string.Format("{0:dd/MM/yyyy}", strToDate) + " of " + strBranchName + "</font></b><br><br></center>";
