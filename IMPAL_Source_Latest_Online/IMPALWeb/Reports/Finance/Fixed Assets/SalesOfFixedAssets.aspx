<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="SalesOfFixedAssets.aspx.cs" Inherits="IMPALWeb.Reports.Finance.Fixed_Assets.SalesOfFixedAssets" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportFilters">
        <table id="reportFiltersTable" class="reportFiltersTable" runat="server">
            <tr>
                <td class="label">
                    <asp:Label ID="lblFromDate" runat="server" Text="From Date of Sale" SkinID="LabelNormal"></asp:Label>
                ...
                <td class="label">
                    <asp:Label ID="lblToDate" runat="server" Text="To Date of Sale" SkinID="LabelNormal"></asp:Label>
                    <span class="asterix">*</span>
                </td>
                <td class="inputcontrols">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc1:CrystalReport runat="server" ID="crsalesoffixedasset" OnUnload="crsalesoffixedasset_Unload" />
    </div>
</asp:Content>
