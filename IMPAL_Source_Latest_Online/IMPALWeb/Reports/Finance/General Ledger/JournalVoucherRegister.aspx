<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="JournalVoucherRegister.aspx.cs" Inherits="IMPALWeb.Reports.Finance.General_Ledger.JournalVoucherRegister" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <asp:UpdatePanel ID="upHeader" runat="server" UpdateMode="Conditional">
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="crDebitCredit" />
        </Triggers>
        <ContentTemplate>
            ...
            <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
                <uc:CrystalReport runat="server" ID="crDebitCredit" OnUnload="crDebitCredit_Unload" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
