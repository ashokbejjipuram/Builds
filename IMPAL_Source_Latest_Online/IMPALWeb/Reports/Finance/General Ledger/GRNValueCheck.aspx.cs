...
{
    public partial class GRNValueCheck : System.Web.UI.Page
    {
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string str_head = "";
                btnReport.Text = "Back";
                string filename = "GRN_Value_Check_with_GL.xls";

                SalesTransactions salesItem = new SalesTransactions();

                ds = salesItem.GetGRNValueCheckDetails(pstrBranchCode, strFromDate, strToDate);
