<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="POTaxListing.aspx.cs" Inherits="IMPALWeb.Reports.Finance.SalesTax.POTaxListing"
    ...
    <div class="reportFilters">
        <table id="reportFiltersTable" class="reportFiltersTable" runat="server">
            <tr>
                ...
                <td class="inputcontrols">
                    <asp:DropDownList ID="ddlReportType" TabIndex="3" runat="server" SkinID="DropDownListNormal"
        ...
        <div class="reportButtons">
            <asp:Button ID="btnReport" runat="server" OnClick="btnReport_Click" OnClientClick="javaScript:return Validate();"
                Text="Generate Report" SkinID="ButtonViewReport" TabIndex="4" />
        </div>
    </div>
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc:CrystalReport ID="rptCrystal" runat="server" OnUnload="rptCrystal_Unload" ReportName="VATListing" />
    </div>
</asp:Content>
