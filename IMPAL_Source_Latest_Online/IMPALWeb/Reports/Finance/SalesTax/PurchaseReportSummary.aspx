<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseReportSummary.aspx.cs"
    Inherits="IMPALWeb.Reports.Finance.SalesTax.PurchaseReportSummary" MasterPageFile="~/Main.Master" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc:CrystalReport ID="rptCrystal" runat="server" OnUnload="rptCrystal_Unload" ReportName="PurchaseReportSummary" />
    </div>
</asp:Content>
