<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LocalStatePurchase.aspx.cs"
    MasterPageFile="~/Main.Master" Inherits="IMPALWeb.Reports.Finance.SalesTax.LocalStatePurchase" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc:CrystalReport ID="rptCrystal" runat="server" OnUnload="rptCrystal_Unload" ReportName="LocalStatePurchase" />
    </div>
</asp:Content>
