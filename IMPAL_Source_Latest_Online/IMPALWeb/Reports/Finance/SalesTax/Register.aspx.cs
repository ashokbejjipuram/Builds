        ...
        private void CallCrystalReport()
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(strBranchCode))
                {
                    ...
                    oFinance.UpdateCSTActDetails(strBranchCode, txtFromDate.Text, txtToDate.Text);

                    string strSelectionFormula = null;
                    string strDateQuery = "{cst_act.invoice_date}";
                    string strBranchQuery = "{cst_act.branch_code}";
