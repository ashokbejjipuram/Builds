<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listing.aspx.cs" Inherits="IMPALWeb.Reports.Finance.SalesTax.Listing"
...
<asp:Content ID="Content" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc:CrystalReport ID="crListing" runat="server" OnUnload="crListing_Unload" />
    </div>
</asp:Content>
