<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="STUDepotForm.aspx.cs" Inherits="IMPALWeb.Reports.Finance.SalesTax.STUDepotForm"
...
<asp:Content ID="Content" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc:CrystalReport ID="rptCrystal" runat="server" OnUnload="rptCrystal_Unload" ReportName="STUDepotForm" />
    </div>
</asp:Content>
