<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CFormCustomer.aspx.cs"
    Inherits="IMPALWeb.Reports.Finance.SalesTax.CFormCustomer" MasterPageFile="~/Main.Master" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <UC:CrystalReport ID="rptCrystal" runat="server" OnUnload="rptCrystal_Unload" ReportName="CForm-Customer" />
    </div>
</asp:Content>
