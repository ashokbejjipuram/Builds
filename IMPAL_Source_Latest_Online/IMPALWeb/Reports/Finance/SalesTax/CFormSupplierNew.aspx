<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CFormSupplierNew.aspx.cs"
    Inherits="IMPALWeb.Reports.Finance.SalesTax.CFormSupplierNew" MasterPageFile="~/Main.Master" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function Validate() {
            ...
            var ddlFromDate = document.getElementById('<%=ddlFromDate.ClientID%>');
    ...
    <div class="reportFilters">
        <table id="reportFiltersTable" class="reportFiltersTable" runat="server">
            ...
            <tr>
                ...
                <td class="inputcontrols">
                    <asp:DropDownList ID="ddlFromDate" TabIndex="1" runat="server" SkinID="DropDownListNormal"
                        AutoPostBack="true" OnSelectedIndexChanged="ddlFromDate_IndexChanged">
                    </asp:DropDownList>
                </td>
                <td class="label">
                ...
                <td class="inputcontrols">
                    <asp:TextBox ID="txtToDate" runat="server" TabIndex="2" SkinID="TextBoxCalendarExtenderNormal" ReadOnly="true" />
                </td>
            </tr>
            <tr>
                <td class="label">
                ...
                <td class="inputcontrols">
                    <asp:DropDownList ID="ddlReportType" TabIndex="5" runat="server" SkinID="DropDownListNormal"
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <UC:CrystalReport ID="rptCrystal" runat="server" OnUnload="rptCrystal_Unload" ReportName="CForm-SupplierNew" />
    </div>
</asp:Content>
