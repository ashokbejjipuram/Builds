<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InterStatePurchase.aspx.cs"
    MasterPageFile="~/Main.Master" Inherits="IMPALWeb.Reports.Finance.SalesTax.InterStatePurchase" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc:CrystalReport ID="rptCrystal" runat="server" OnUnload="rptCrystal_Unload" ReportName="InterStatePurchase" />
    </div>
</asp:Content>
