<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormSalesSummary.aspx.cs"
    Inherits="IMPALWeb.Reports.Finance.SalesTax.FormSalesSummary" MasterPageFile="~/Main.Master" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <uc:CrystalReport ID="rptCrystal" runat="server" OnUnload="rptCrystal_Unload" ReportName="FormSalesSummary" />
    </div>
</asp:Content>
