<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsOutwardRegister.aspx.cs"
    Inherits="IMPALWeb.Reports.Inventory.GoodsOutwardRegister" MasterPageFile="~/Main.Master" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <asp:UpdatePanel ID="upHeader" runat="server" UpdateMode="Conditional">
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="crGoodsOutwardRegister" />
        </Triggers>
        <ContentTemplate>
            ...
            <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
                <UC:CrystalReport ID="crGoodsOutwardRegister" runat="server" OnUnload="crGoodsOutwardRegister_Unload" ReportName="GoodsOutward" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
