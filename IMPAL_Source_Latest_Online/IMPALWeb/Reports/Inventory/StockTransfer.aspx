<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockTransfer.aspx.cs"
    Inherits="IMPALWeb.Reports.Inventory.StockTransfer" MasterPageFile="~/Main.Master" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportFormTitle">
        Branch/Line - Stock Transfer</div>
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <UC:CrystalReport ID="crStockTransfer" runat="server" OnUnload="crStockTransfer_Unload" ReportName="StockTransfer" />
    </div>
</asp:Content>
