...
{
    public partial class slbwithtod_gpdetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    if (crslbwithtodgpdetails != null)
                    {
                        crslbwithtodgpdetails.Dispose();
                        crslbwithtodgpdetails = null;
                    }
        ...
        protected void crslbwithtodgpdetails_Unload(object sender, EventArgs e)
        {
            if (crslbwithtodgpdetails != null)
            {
                crslbwithtodgpdetails.Dispose();
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (btnReport.Text == "Back")
                {
                    ...
                    crslbwithtodgpdetails.ReportName = "Impal-report-SLB_TOD_GP";
                    crslbwithtodgpdetails.RecordSelectionFormula = strSelectionFormula;
                    crslbwithtodgpdetails.GenerateReport();
                }
            }
            catch (Exception exp)
            {
