...
{
    public partial class cost_slb_gpworking : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    if (crslbgpworking != null)
                    {
                        crslbgpworking.Dispose();
                        crslbgpworking = null;
                    }
        ...
        protected void crslbgpworking_Unload(object sender, EventArgs e)
        {
            if (crslbgpworking != null)
            {
                crslbgpworking.Dispose();
        ...
        protected void fnPopulateLineCode()
        {
            ...
            try
            {
                ...
                ddllinecode.DataSource = objlinecode.GetLineCodeforSLB(ddlbranchcode.SelectedValue);
            ...
            try
            {
                ...
                if (btnReport.Text == "Back")
                {
                    ...
                    if (!string.IsNullOrEmpty(strBranchCode))
                    {
                        ...
                        string SLBLinecode = "{SLB_Item_calculation.Supplier_line_code}";
                    ...
                    crslbgpworking.ReportName = "Impal-report-costslb-gpworking";
                    crslbgpworking.RecordSelectionFormula = strSelectionFormula;
                    crslbgpworking.GenerateReport();
                }
            }
            catch (Exception exp)
            {
