<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="slb_structure_summary.aspx.cs"
    Inherits="IMPALWeb.Reports.SLB.slb_structure_summary" %>

<%@ Register Src="~/UserControls/CrystalReport.ascx" TagName="CrystalReport" TagPrefix="UC" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajax" %>
<asp:Content ID="MainContent" ContentPlaceHolderID="CPHDetails" runat="server">
    <div class="reportFormTitle">
        SLB-Structure-Summary
    </div>
    ...
    <%--       ReportName="Impal-report-SLBstruc-summary"--%>
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        <UC:CrystalReport ID="crslbsummary" runat="server" OnUnload="crslbsummary_Unload" />
    </div>
</asp:Content>
