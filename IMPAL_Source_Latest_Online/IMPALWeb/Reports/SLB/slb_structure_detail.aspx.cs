...
{
    public partial class slb_structure_detail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    if (crslbdetails != null)
                    {
                        crslbdetails.Dispose();
                        crslbdetails = null;
                    }
        ...
        protected void crslbdetails_Unload(object sender, EventArgs e)
        {
            if (crslbdetails != null)
            {
                crslbdetails.Dispose();
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (btnReport.Text == "Back")
                {
                    ...
                    crslbdetails.ReportName = "Impal-report-SLBstruc-detail";
                    crslbdetails.RecordSelectionFormula = strSelectionFormula;
                    crslbdetails.GenerateReport();
                }
            }
            catch (Exception exp)
            {
