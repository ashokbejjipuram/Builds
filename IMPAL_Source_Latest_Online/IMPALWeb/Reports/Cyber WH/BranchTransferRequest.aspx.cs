...
{
    public partial class BranchTransferRequest : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    if (crBranchTransferRequest != null)
                    {
                        crBranchTransferRequest.Dispose();
                        crBranchTransferRequest = null;
                    }
        ...
        protected void crBranchTransferRequest_Unload(object sender, EventArgs e)
        {
            if (crBranchTransferRequest != null)
            {
                crBranchTransferRequest.Dispose();
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (btnReport.Text == "Back")
                {
                    ...
                    string strPONumber = "{STDN_Request_Header.PO_number}";
                    string strFrombranchcode = "{STDN_Request_Header.From_branch_code}";
                    string rptName = "Impal-report-branch_transfer_request";
                    ...
                    crBranchTransferRequest.ReportName = rptName;
                    crBranchTransferRequest.RecordSelectionFormula = strSelectionFormula;
                    crBranchTransferRequest.GenerateReport();
                }
            }
            catch (Exception exp)
            {
