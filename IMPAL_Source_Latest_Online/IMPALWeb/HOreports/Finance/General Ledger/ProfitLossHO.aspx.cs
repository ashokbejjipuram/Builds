...
{
    public partial class ProfitLossHO : System.Web.UI.Page
    {
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (btnReport.Text == "Back")
                {
                    ...
                    if (ddlReportType.SelectedValue == "Detail")
                        str_head = "<center><b><font size='6'>Profit & Loss Account Details for the period ended " + txtToDate.Text + "</font></b><br><br></center>";
                    else
                        str_head = "<center><b><font size='6'>Profit & Loss Account Summary for the period ended " + txtToDate.Text + "</font></b><br><br></center>";
