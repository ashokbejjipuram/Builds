...
{
    public partial class GeneralLedgerHO : System.Web.UI.Page
    {
        #region Declaration
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    ddlBranch.DataSource = oFinance.GetGLBranchesHO();
        ...
        private void CallCrystalReport()
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(strBranchCode))
                {
                    ...
                    oFinance.CalculateGeneralLedgerHO(oProp);
                }
            }
            catch (Exception exp)
            {
        ...
        private void LoadAccPeriodDDL()
        {
            ...
            try
            {
                ...
                {
                    AccountingPeriods oAcc = new AccountingPeriods();
                    ddlAccPeriod.DataSource = oAcc.GetAccountingPeriod(0, "GLHO", strBranchCode);
                    ddlAccPeriod.DataTextField = "Desc";
                    ddlAccPeriod.DataValueField = "AccPeriodCode";
                    ddlAccPeriod.DataBind();
                }
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("GeneralLedgerHO.aspx", false);
