...
{
    public partial class OutstandingReportsHO : System.Web.UI.Page
    {
        #region Declaration
        ...
        protected void LoadReportType()
        {
            ...
            try
            {
                ...
                ddlReportType.DataSource = oCommon.GetDropDownListValues("Outstanding_Reports");
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (btnReport.Text == "Back")
                {
                    ...
                    ds = salesItem.GetOutstandingReportDetails(Session["BranchCode"].ToString(), date1, date2, ddlReportType.SelectedValue);
