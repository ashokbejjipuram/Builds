...
{
    public partial class TrialBalanceHoLive : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (btnReport.Text == "Back")
                {
                    ...
                    if (ddlReportType.SelectedValue == "Report")
                    {
                        ...
                        str_head = "<center><b><font size='6'>Trial Balance Report for the Period " + txtFromDate.Text + " - " + txtToDate.Text + "</font></b><br><br></center>";
                    ...
                    else if (ddlReportType.SelectedValue == "AuditDetail")
                    {
                        ...
                        string strBranchName = (string)Session["UserName"];
                        str_head = "<center><b><font size='6'>Trial Balance Audit Report for the Period " + txtFromDate.Text + " - " + txtToDate.Text + " </font></b><br><br></center>";
