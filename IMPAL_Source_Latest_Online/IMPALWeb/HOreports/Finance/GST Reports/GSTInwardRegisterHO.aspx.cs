...
{
    public partial class GSTInwardRegisterHO : System.Web.UI.Page
    {
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ds = salesItem.GetGSTInwardRegisterDetailsHO(zone, state, branch, date1, date2);
                ...
                if (zone == "--All--" && state == "--All--" && branch == "--All--")
                    filename = ds.Tables[1].Rows[0]["GSTIN"].ToString() + "_InWard_" + ds.Tables[1].Rows[0]["MonthYear"].ToString() + ".xls";
                else if (zone != "--All--" && state == "--All--" && branch == "--All--")
                    filename = ddlZone.SelectedItem.Text + "_InWard_" + ds.Tables[1].Rows[0]["MonthYear"].ToString() + ".xls";
                else if (zone != "--All--" && state != "--All--" && branch == "--All--")
                    filename = ddlState.SelectedItem.Text + "_InWard_" + ds.Tables[1].Rows[0]["MonthYear"].ToString() + ".xls";
                else if (zone != "--All--" && state != "--All--" && branch != "--All--")
                    filename = ddlBranch.SelectedItem.Text + "_InWard_" + ds.Tables[1].Rows[0]["MonthYear"].ToString() + ".xls";
