<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="GSTOutwardRegisterHO.aspx.cs" Inherits="IMPALWeb.Reports.Finance.GSTReports.GSTOutwardRegisterHO" %>
            ...
            <tr>
                ...
                <td class="inputcontrols">
                    <asp:DropDownList ID="ddlReportType" runat="server" SkinID="DropDownListNormal" TabIndex="3">
                        <asp:ListItem Text="GST Outward Register" Value="GST Outward Register"></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
