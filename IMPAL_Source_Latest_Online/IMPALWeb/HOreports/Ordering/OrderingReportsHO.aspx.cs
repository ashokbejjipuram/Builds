...
{
    public partial class OrderingReportsHO : System.Web.UI.Page
    {
        #region Declaration
        ...
        protected void LoadReportType()
        {
            ...
            try
            {
                ...
                ddlReportType.DataSource = oCommon.GetDropDownListValues("Ordering_Reports");
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ds = salesItem.GetOrderingReportDetails(Session["BranchCode"].ToString(), date1, date2, ddlReportType.SelectedValue);
