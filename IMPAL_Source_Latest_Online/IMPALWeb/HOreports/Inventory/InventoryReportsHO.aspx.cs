...
{
    public partial class InventoryReportsHO : System.Web.UI.Page
    {
        #region Declaration
        ...
        protected void LoadReportType()
        {
            ...
            try
            {
                ...
                ddlReportType.DataSource = oCommon.GetDropDownListValues("Inventory_Reports");
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (btnReport.Text == "Back")
                {
                    ...
                    ds = salesItem.GetInventoryReportDetails(Session["BranchCode"].ToString(), date1, date2, ddlReportType.SelectedValue);
