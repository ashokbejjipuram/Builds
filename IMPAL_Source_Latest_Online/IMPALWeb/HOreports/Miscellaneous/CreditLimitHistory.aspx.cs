...
{
    public partial class CreditLimitHistory : System.Web.UI.Page
    {
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ds = salesItem.GetCreditLimitHistoryDetails(ddlBranch.SelectedValue, date1, date2);
                string strBranchName = (string)Session["BranchName"];                

                string filename = "Credit_Limit_History" + "_" + DateTime.Now.ToString("yyyyMMdd") + "_" + DateTime.Now.ToString("HHmmssfff") + ".xls";
