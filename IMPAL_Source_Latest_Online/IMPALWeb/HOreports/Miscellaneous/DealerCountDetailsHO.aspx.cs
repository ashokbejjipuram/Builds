...
{
    public partial class DealerCountDetailsHO : System.Web.UI.Page
    {
        #region Declaration
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (ddlBranch.SelectedIndex > 0)
                    filename = "New_Dealer_Count_" + ddlBranch.SelectedValue + "_" + ddlReportType.SelectedItem.Text + "_" + date1.Replace("/", "") + " to " + date2.Replace("/", "") + ".xls";
                else
                    filename = "All_Branches_New_Dealer_Count_" + ddlReportType.SelectedItem.Text + "_" + date1.Replace("/", "") + " to " + date2.Replace("/", "") + ".xls";

                SalesTransactions salesItem = new SalesTransactions();
                ds = salesItem.GetDealerCountDetailsReport(ddlBranch.SelectedValue, date1, date2, ddlReportType.SelectedValue);
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("DealerCountDetailsHO.aspx", false);
