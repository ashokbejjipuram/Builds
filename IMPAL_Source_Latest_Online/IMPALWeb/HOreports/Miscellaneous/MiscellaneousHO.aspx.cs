...
{
    public partial class MiscellaneousHO : System.Web.UI.Page
    {
        #region Declaration
        ...
        protected void LoadReportType()
        {
            ...
            try
            {
                ...
                ddlReportType.DataSource = oCommon.GetDropDownListValues("Miscellaneous-Reports-HO");
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (btnReport.Text == "Back")
                {
                    ...
                    ds = salesItem.GetMiscellaneousReportDetailsHO(Session["BranchCode"].ToString(), date1, date2, ddlReportType.SelectedValue);
