<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DealerCountDetailsHO.aspx.cs"
    Inherits="IMPALWeb.Reports.Miscellaneous.DealerCountDetailsHO" MasterPageFile="~/Main.Master" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportFormTitle reportFormTitleExtender250">
        New Dealer Count & Details Report
    </div>
            ...
            <tr>
                ...
                <td class="inputcontrols">
                    <asp:DropDownList ID="ddlBranch" runat="server" DataTextField="BranchName" DataValueField="BranchCode"
                        TabIndex="1" SkinID="DropDownListNormal" />
                </td>
                <td class="label">
