<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="LineWiseSalesValueHO.aspx.cs"
    Inherits="IMPALWeb.Reports.Sales.SalesListing.LineWiseSalesValueHO" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        ...
        <asp:GridView ID="grdHOLineWiseValue" runat="server" Width="100%" AutoGenerateColumns="true" OnRowDataBound="grdHOLineWiseValue_RowDataBound"
            AllowPaging="true" CssClass="Grid" AlternatingRowStyle-CssClass="alt" OnPageIndexChanging="grdHOLineWiseValue_PageIndexChanging"
