...
{
    public partial class DateWiseSalesValueHO : System.Web.UI.Page
    {
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Server.ClearError();
                    Response.Redirect("DateWiseSalesValueHO.aspx", false);
        ...
        private void BindReport()
        {
            ...
            { 
                ...
                dt = reportsData.GetTableData("[dbo].[usp_rpt_Datewisesalesvalue_HO]", lstparam); 
            }
            else
            {
