<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="CustomerOutstandingHO.aspx.cs"
    Inherits="IMPALWeb.CustomerOutstandingHO" %>
                                ...
                                <tr>
                                    ...
                                    <td class="inputcontrols">
                                        <asp:DropDownList ID="ddlBranch" runat="server" DataTextField="BranchName" DataValueField="BranchCode" AutoPostBack="true"
                                            TabIndex="1" Enabled="false" SkinID="DropDownListNormal" OnSelectedIndexChanged="ddlBranch_OnSelectedIndexChanged" />
                                    </td>
                                    <td class="label">
