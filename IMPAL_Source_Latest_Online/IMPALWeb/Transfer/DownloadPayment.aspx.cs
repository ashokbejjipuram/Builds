...
{
    public partial class DownloadPayment : System.Web.UI.Page
    {
        ...
        protected void DownloadBranchTables()
        {
            ...
            try
            {
                if (downloadResult.Contains(serverDownloadFolder))
                {
                    ...
                    dataSetBranchTables = download.DownloadPaymentBranchTableDetails((string)Session["BranchCode"]);
                    ...
                    foreach (DataTable table in dataSetBranchTables.Tables)
                    {
                        foreach (DataRow row in table.Rows)
                        {
                            ...
                            if (download.DownloadPaymentCorporateData(downloadResult, (string)Session["BranchCode"], tableName, tableColumnsCount))
                            {
                                ...
                                download.DownloadPaymentUpdateCorporateData(downloadResult, (string)Session["BranchCode"], tableName, tableColumnsCount);
                            }
                            else
                            {
                                Session["DownloadTableDetails"] = Session["DownloadTableDetails"].ToString() +
