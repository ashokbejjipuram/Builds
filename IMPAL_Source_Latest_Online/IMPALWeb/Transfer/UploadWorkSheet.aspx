<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="UploadWorkSheet.aspx.cs"
    Inherits="IMPALWeb.Transfer.UploadWorkSheet" %>
                ...
                <div id="divUpload" runat="server">
                    ...
                    <div class="transactionButtons">
                        <div class="transactionButtonsHolder">
                            <asp:Button ID="btnUpload" runat="server" Text="WorkSheet Upload" SkinID="ButtonNormalBig" OnClientClick="javaScript:return ValidationSubmit();"
                                OnClick="btnUpload_Click" on />
