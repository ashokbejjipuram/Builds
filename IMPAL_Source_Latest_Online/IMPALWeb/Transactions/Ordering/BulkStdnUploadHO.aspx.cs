...
namespace IMPALWeb
{
    public partial class BulkStdnUploadHO : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            {
                Log.WriteException(typeof(BulkStdnUploadHO), exp);
            }
        }
        ...
        protected void btnUploadExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    filePath = @"D:\Downloads\BulkSTDNHO";

                    string filePathDest = @"D:\Downloads\BulkSTDNHO\Old";
                    ...
                    if (File.Exists(filePath + "\\" + fileName))
                    {
                        ...
                        while (dr.Read())
                        {
                            ...
                            {
                                sqlTotQuery = "Insert into Bulk_STDN_Upload_HO values ('" + dr[0] + "','" + dr[1] + "','" + dr[2] + "','" + dr[3] + "','" + dr[4] + "',NULL,'" + fileName + "',GETDATE())";
                            ...
                            else
                            {
                                ...
                                ScriptManager.RegisterStartupScript(this, this.GetType(), "Javascript", "alert('From and To Branch cannot be same. Please check once.');", true);
                                return;
                            }
                        }
                        ...
                        else
                        {
                            if (File.Exists(filePath + "\\" + fileName))
                            {
                                cmd = ImpalDb.GetStoredProcCommand("usp_AddSTDN_BulkUpload_HO");
        ...
        protected void DeleteTempRows(string excelFileName)
        {
            Database ImpalDb = DataAccess.GetDatabase();
            string sqlTotQuery = "delete from Bulk_STDN_Upload_HO where ExcelFileName='" + excelFileName + "'";
        ...
        {
            Server.ClearError();
            Response.Redirect("BulkStdnUploadHO.aspx", false);
