<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="StockTransferReceiptFinal.aspx.cs"
    Inherits="IMPALWeb.StockTransferReceiptFinal" Title="Stock Transfer Receipt - Final" EnableEventValidation="false"
                ...
                <div id="DivOuter" runat="server">
                    <div id="DivHeader" runat="server">
                        <div class="subFormTitle subFormTitleExtender300">
                            STOCK TRANSFER RECEIPT - APPROVAL</div>
                        ...
                        <table class="subFormTable">
                            ...
                            <tr>
                                ...
                                <td class="inputcontrols">
                                    <asp:DropDownList ID="ddlTransactionType" runat="server" AutoPostBack="false" SkinID="DropDownListDisabledBig"
                                ...
                                <td class="inputcontrols">
                                    <asp:DropDownList ID="ddlFromBranch" Enabled="true" runat="server" DataSourceID="ODS_AllBranch"
                                        DataTextField="BranchName" SkinID="DropDownListDisabled" DataValueField="BranchCode" AutoPostBack="true" OnSelectedIndexChanged="ddlFromBranch_OnSelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                                <td class="label">
                            ...
                            <tr>
                                ...
                                <td class="inputcontrols">
                                    <asp:TextBox ID="txtWarehouseDate" runat="server" Enabled="false" SkinID="TextBoxDisabled"
                                        onblur="javaScript:return Validate(this.id, 'Ware House');"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="label">
                                    <asp:Label ID="Label17" runat="server" SkinID="LabelNormal" Text="From Branch STDN #"></asp:Label>
                                </td>
                                <td class="inputcontrols">
                                    <asp:TextBox ID="txtFromBranchSTDNNo" runat="server" MaxLength="9" Enabled="false" SkinID="TextBoxDisabled" 
                                    onkeypress="return AlphaNumericWithSlash();"></asp:TextBox>
                                </td>
                                <td class="label">
                                    <asp:Label ID="Label16" runat="server" SkinID="LabelNormal" Text="From Branch STDN Date"></asp:Label>
                                </td>
                                <td class="inputcontrols">
                                    <asp:TextBox ID="txtFromBranchSTDNDate" runat="server" Enabled="false" SkinID="TextBoxDisabled"
                                        onblur="javaScript:return Validate(this.id, 'Ware House');"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <asp:GridView ID="grvItemDetails" runat="server" AutoGenerateColumns="False" OnRowDataBound="grvItemDetails_RowDataBound" SkinID="GridViewScroll">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Orig Rcpt Dt" ItemStyle-Wrap="false">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtOriginalReceiptDate" runat="server" SkinID="TextBoxDisabled" Width="80" AutoPostBack="false"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="List Price" ItemStyle-Wrap="false">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtListPrice" runat="server" SkinID="TextBoxDisabled" Width="80" AutoPostBack="false"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Cost Price/Qty">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtCstPricePerQty" contentEditable="true" runat="server" SkinID="TextBoxDisabled" Width="80"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Received Qty">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtReceivedQuantity" runat="server" SkinID="TextBoxDisabled" Width="80" onkeypress="return IntegerValueOnly();"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Accepted Qty">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtAcceptedQuantity" runat="server" SkinID="TextBoxDisabled" Width="80" onkeypress="return IntegerValueOnly();"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Location Code">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtItemLocation" Enabled="false" runat="server" SkinID="TextBoxDisabled" Width="110"> </asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Tot Cost Price">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtTotalCostPrice" Enabled="false" runat="server" Width="80" SkinID="TextBoxDisabled"></asp:TextBox></ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="OS/LS">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtOSLSIndicator" Enabled="false" runat="server" Width="30" SkinID="TextBoxDisabled"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="GST %">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtGSTPercentage" runat="server" SkinID="TextBoxDisabledSmall" Enabled="false" Width="50" onkeypress="return CurrencyNumberOnly();"></asp:TextBox></ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Supp. Inv #" Visible="false">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtInvoiceNumber" contentEditable="true" runat="server" SkinID="TextBoxDisabled" Width="100"></asp:TextBox></ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Supp. Inv Dt" Visible="false">
                                                <ItemTemplate>
                                                    ...
                                                    SkinID="TextBoxDisabled" Width="100"></asp:TextBox>
