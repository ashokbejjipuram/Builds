...
namespace IMPALWeb
{
    public partial class WarrantyClaimLucasHandlingCharges : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    if (cryHandlingChargesReprint != null)
                    {
                        cryHandlingChargesReprint.Dispose();
                        cryHandlingChargesReprint = null;
                    }

                    hdnScreenMode.Value = "A";
                    txtHandlingChargesDate.Text = DateTime.Today.ToString("dd/MM/yyyy");
                    ddlHandlingChargesNumber.Visible = false;
                ...
                BtnSubmit.Attributes.Add("OnClick", "return HandlingChargesEntrySubmit('E');");
            ...
            {
                Log.WriteException(typeof(WarrantyClaimLucasHandlingCharges), exp);
            }
        }
        ...
        protected void cryHandlingChargesReprint_Unload(object sender, EventArgs e)
        {
            if (cryHandlingChargesReprint != null)
            {
                cryHandlingChargesReprint.Dispose();
        ...
        protected void imgEditToggle_Click(object sender, EventArgs e)
        {
            try
            {
                if (hdnScreenMode.Value == "A")
                {
                    ...
                    ddlHandlingChargesNumber.SelectedValue = "0";
                    ddlHandlingChargesNumber.Visible = true;
                    txtHandlingChargesNumber.Visible = false;
                    ddlHandlingChargesNumber.DataBind();
                    ddlWarrantyClaimNumber.Enabled = false;
                    txtWarrantyClaimDate.Enabled = false;
                    txtHandlingCharges.Enabled = false;
                ...
                else if (hdnScreenMode.Value == "E")
                {
                    hdnScreenMode.Value = "A";
                    ddlHandlingChargesNumber.Visible = false;
                    txtHandlingChargesNumber.Visible = true;

                    txtHandlingChargesNumber.Text = string.Empty;
                    txtHandlingChargesDate.Text = DateTime.Today.ToString("dd/MM/yyyy");
        ...
        protected void BtnReport_Click(object sender, EventArgs e)
        {
            ...
            if (ddlHandlingChargesNumber.Visible)
                strValue = ddlHandlingChargesNumber.SelectedValue;
            else
                strValue = txtHandlingChargesNumber.Text;

            strSelectionFormula = strField + "= " + "'" + strValue + "'";
            strReportName = "WarrantyClaim_Lucas_HandlingCharges";
            ...
            cryHandlingChargesReprint.ReportName = strReportName;
            cryHandlingChargesReprint.RecordSelectionFormula = strSelectionFormula;
            cryHandlingChargesReprint.GenerateReportAndExportA4();
        }
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("WarrantyClaimLucasHandlingCharges.aspx", false);
        ...
        protected void ddlHandlingChargesNumber_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlHandlingChargesNumber.SelectedValue != "0")
            {
                StockTransferTransactions stocktransferTransactions = new StockTransferTransactions();
                WarrantyClaimLucasEntity warrantyclaimLucas = stocktransferTransactions.GetWarrantyClaimLucasLabourHandlingChargesDetails(ddlBranch.SelectedValue, ddlHandlingChargesNumber.SelectedValue.ToString());

                ddlBranch.SelectedValue = warrantyclaimLucas.BranchCode;
                ddlHandlingChargesNumber.SelectedValue = warrantyclaimLucas.LabourHandlingNumber;
                txtHandlingChargesDate.Text = warrantyclaimLucas.LabourHandlingDate;
                ...
                txtWarrantyClaimDate.Text = warrantyclaimLucas.WarrantyClaimDate;
                txtHandlingCharges.Text = TwoDecimalConversion(warrantyclaimLucas.LabourHandlingCharges);
                ...
                if (txtHandlingChargesDate.Text == DateTime.Today.ToString("dd/MM/yyyy"))
                {
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                if (ddlStatus.SelectedValue == "Inactive" && txtHandlingChargesDate.Text == DateTime.Today.ToString("dd/MM/yyyy"))
                {
                    StockTransferTransactions tran = new StockTransferTransactions();
                    DataSet ds = tran.EditWarrantyClaimLabourHandlingEntry(ddlBranch.SelectedValue ,ddlHandlingChargesNumber.SelectedValue, "I", "I", "Wrong Entry");
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        einvGen.EinvoiceAuthentication(JSONData, ddlBranch.SelectedValue.ToString(), ddlHandlingChargesNumber.SelectedItem.Text.ToString(), "2", "CANIRN", ds.Tables[0].Rows[0]["GSTIN"].ToString(), ds.Tables[0].Rows[0]["Document_Type"].ToString(), ds.Tables[0].Rows[0]["Document_Date"].ToString().Replace("-", "/"), ds);
                    }
                    ...
                    ddlHandlingChargesNumber.Enabled = false;
        ...
        private void SubmitHeaderAndItems()
        {
            try
            {
                ...
                if (ddlHandlingChargesNumber.Visible)
                    warrantyclaimEntity.LabourHandlingNumber = ddlHandlingChargesNumber.SelectedValue.ToString();
                else
                    warrantyclaimEntity.LabourHandlingNumber = txtHandlingChargesNumber.Text.ToString();

                warrantyclaimEntity.LabourHandlingDate = txtHandlingChargesDate.Text.ToString();
                ...
                warrantyclaimEntity.LabourHandlingCharges = txtHandlingCharges.Text;
                ...
                if (hdnScreenMode.Value == "A")
                {
                    ...
                    {
                        txtHandlingChargesNumber.Text = warrantyclaimEntity.LabourHandlingNumber;
                        ...
                        ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "IMPAL", "alert('Handling Charges Entry Has been Generated Successfully with QR Code.');", true);
                        BtnReport.Enabled = true;
                    }
                    else
                    {
