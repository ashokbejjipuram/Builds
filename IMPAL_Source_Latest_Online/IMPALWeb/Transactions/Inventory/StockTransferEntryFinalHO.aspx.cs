...
namespace IMPALWeb
{
    public partial class StockTransferEntryFinalHO : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    if ((string)Session["RoleCode"] == "IAUD")
            ...
            {
                Log.WriteException(typeof(StockTransferEntryFinalHO), exp);
            }
        }
        ...
        protected void BtnReport_Click(object sender, EventArgs e)
        {
            ...
            ImpalDB.AddInParameter(cmdtemps, "@Branch_Code", DbType.String, ddlBranch.SelectedValue);
            ...
            if (signedQRCode.ToString() != "")
            {
                ...
                salesTransactions.updEinvoiceIRNDetails(ddlBranch.SelectedValue, strValue, imageData);
            }
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("StockTransferEntryFinalHO.aspx", false);
        ...
        protected void ddlStockTransferNumber_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    StockTransferTransactions stockTransferTransactions = new StockTransferTransactions();
                    StockTransferEntity stockTransferEntity = stockTransferTransactions.GetSTDNEntryDetailsByNumber(ddlStockTransferNumber.SelectedValue.Substring(11, 3), ddlStockTransferNumber.SelectedValue.ToString());

                    txtStockTransferNumber.Text = stockTransferEntity.StockTransferNumber;
                    ddlStockTransferNumber.SelectedValue = txtStockTransferNumber.Text;
                    ...
                    else if (stockTransferEntity.ApprovalStatus == "E")
                    {
                    ...
                    foreach (GridViewRow gvr in grvItemDetails.Rows)
                    {
                        ...
                        if (gvr.FindControl("btnSearch") != null)
        ...
        protected void BtnReject_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataSet Datasetresult = tran.EditSTEntry(ddlBranch.SelectedValue, ddlStockTransferNumber.SelectedValue, "I", "R", Session["STDNOutWardRemarks"].ToString());
        ...
        protected void BtnCancel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataSet ds = tran.EditSTEntry(ddlBranch.SelectedValue, ddlStockTransferNumber.SelectedValue, "I", "I", Session["STDNOutWardRemarks"].ToString());
        ...
        private void DefineBranch()
        {
            try
            {
                if (Session["RoleCode"].ToString().ToUpper() == "IAUD")
                {
