<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="WarrantyClaimLucas.aspx.cs"
    Inherits="IMPALWeb.WarrantyClaimLucas" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <script src="../../Javascript/WarrantyClaimLucas.js" type="text/javascript"></script>
    ...
    <div id="DivTop" runat="server" style="width: 100%">
        <asp:UpdatePanel ID="UpdpanelTop" runat="server" UpdateMode="Conditional">
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="txtWarrantyClaimNumber" />
                        ...
                        <asp:Panel ID="pnlSTEntry" runat="server">
                            <table class="subFormTable">
                                <tr>
                                    ...
                                    <td class="inputcontrols">
                                        <asp:TextBox ID="txtWarrantyClaimNumber" runat="server" SkinID="TextBoxDisabled" Enabled="false"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="inputcontrols">
                                        <asp:DropDownList ID="ddlShipTo" runat="server" DataSourceID="ODS_ShipTo" DataTextField="Desc"
                                            DataValueField="Code" SkinID="DropDownListNormal">
                                        </asp:DropDownList>
                                    </td>
                                    ...
                                    <asp:GridView ID="grvItemDetails" runat="server" AutoGenerateColumns="False" OnRowDataBound="grvItemDetails_RowDataBound"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Return Qty">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtQuantity" runat="server" SkinID="GridViewTextBox" onkeypress="return IntegerValueOnly();"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        ...
        <UC:CrystalReport runat="server" ID="cryWarrantyClaimReprint" OnUnload="cryWarrantyClaimReprint_Unload" />
    </div>
    ...
    <asp:ObjectDataSource ID="ODS_WarrantyClaim" runat="server" SelectMethod="GetWarrantyClaimEntries"
    ...
    <asp:XmlDataSource ID="ODS_Transactions" runat="server" DataFile="~/XML/StockTranReq.xml"
        XPath="/Root/WarrantyClaimEntry/TransactionType"></asp:XmlDataSource>

    <asp:XmlDataSource ID="ODS_ShipTo" runat="server" DataFile="~/XML/StockTranReq.xml"
        XPath="/Root/WarrantyClaimEntryShipTo/TransactionType"></asp:XmlDataSource>
</asp:Content>
