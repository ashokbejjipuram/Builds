<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="WarrantyClaimLucasLabourCharges.aspx.cs"
    Inherits="IMPALWeb.WarrantyClaimLucasLabourCharges" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <script src="../../Javascript/WarrantyClaimLucasLabourCharges.js" type="text/javascript"></script>
    ...
    <div id="DivTop" runat="server" style="width: 100%">
        <asp:UpdatePanel ID="UpdpanelTop" runat="server" UpdateMode="Conditional">
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="txtLabourChargesNumber" />
                ...
                <div id="DivOuter" runat="server">
                    <div id="DivHeader" runat="server">
                        <div class="subFormTitle subFormTitleExtender350">
                            WARRANTY CLAIM - LUCAS - LABOUR CHARGES
                        </div>
                        <asp:Panel ID="pnlSTEntry" runat="server">
                            <table class="subFormTable">
                                <tr>
                                    ...
                                    <td class="label">
                                        <asp:Label ID="Label7" runat="server" SkinID="LabelNormal" Text="Labour Charges Number"></asp:Label>
                                    </td>
                                    <td class="inputcontrols">
                                        <asp:TextBox ID="txtLabourChargesNumber" runat="server" SkinID="TextBoxDisabled" Enabled="false"></asp:TextBox>
                                        <asp:DropDownList ID="ddlLabourChargesNumber" runat="server" AutoPostBack="true"
                                            DataSourceID="ODS_LabourChargesNumbers" DataTextField="itemdesc" DataValueField="itemcode"
                                            OnSelectedIndexChanged="ddlLabourChargesNumber_OnSelectedIndexChanged" SkinID="dropdownlistnormal">
                                        </asp:DropDownList>
                                    ...
                                    <td class="label">
                                        <asp:Label ID="Label8" runat="server" SkinID="LabelNormal" Text="Labour Charges Date"></asp:Label>
                                    </td>
                                    <td class="inputcontrols">
                                        <asp:TextBox ID="txtLabourChargesDate" runat="server" SkinID="TextBoxCalendarExtenderDisabled"
                                ...
                                <tr>
                                    ...
                                    <td class="label">
                                        <asp:Label ID="Label25" runat="server" SkinID="LabelNormal" Text="Labour Charges"
                                            MaxLength="12"></asp:Label>
                                        <span class="asterix">*</span>
                                    </td>
                                    <td class="inputcontrols">
                                        <asp:TextBox ID="txtLabourCharges" runat="server" SkinID="TextBoxNormal" MaxLength="12"
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        ...
        <UC:CrystalReport runat="server" ID="cryLabourChargesReprint" OnUnload="cryLabourChargesReprint_Unload" />
    </div>
    ...
    <asp:ObjectDataSource ID="ODS_WarrantyClaim" runat="server" SelectMethod="GetWarrantyClaimEntriesLabourPending"
    ...
    <asp:ObjectDataSource ID="ODS_LabourChargesNumbers" runat="server" SelectMethod="GetLabourChargesEntries"
        TypeName="IMPALLibrary.Transactions.StockTransferTransactions" DataObjectTypeName="IMPALLibrary.Transactions.StockTransferTransactions">
        <SelectParameters>
            <asp:ControlParameter Name="BranchCode" ControlID="ddlBranch" />
        </SelectParameters>
    ...
    <asp:XmlDataSource ID="ODS_Transactions" runat="server" DataFile="~/XML/StockTranReq.xml"
        XPath="/Root/WarrantyClaimLabourChargesEntry/TransactionType"></asp:XmlDataSource>
</asp:Content>
