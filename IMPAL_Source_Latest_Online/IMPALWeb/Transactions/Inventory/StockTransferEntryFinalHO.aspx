<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="StockTransferEntryFinalHO.aspx.cs"
    Inherits="IMPALWeb.StockTransferEntryFinalHO" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <script src="../../Javascript/StockTransferHO.js" type="text/javascript"></script>
                                ...
                                <tr>                                    
                                    ...
                                    <td class="inputcontrols">
                                        <asp:DropDownList ID="ddlBranch" runat="server" DataSourceID="ODS_AllBranch" DataTextField="BranchName"
                                            DataValueField="BranchCode" AutoPostBack="true" OnSelectedIndexChanged="ddlBranch_OnSelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                    <td class="label">
    ...
    <asp:ObjectDataSource ID="ODS_STOCKTRANSENTRY" runat="server" SelectMethod="GetSTDNDespatchEntriesHO"
