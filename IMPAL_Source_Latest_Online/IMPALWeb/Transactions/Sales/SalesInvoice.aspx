<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="SalesInvoice.aspx.cs"
    Inherits="IMPALWeb.SalesInvoiceEntry" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <script src="../../Javascript/SalesInvoice.js" type="text/javascript"></script>
    ...
    <div id="DivTop" runat="server">
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td id="tdSecondaryDispLoc" runat="server" class="inputcontrols">
                                <div><asp:Label ID="Label38" runat="server" Text="Location" SkinID="LabelNormal" style="font-size:13px;font-weight:bold"></asp:Label>:
                                    <asp:DropDownList runat="server" ID="ddlSecondaryDispLoc" SkinID="DropDownListNormal">
                                        <asp:ListItem Text="GP Road" Value="G"></asp:ListItem>
                                        <asp:ListItem Text="SBI Street" Value="S"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </td>
                        </tr>
                    ...
                    <asp:Panel ID="PanelHeaderDtls" runat="server">
                        <table id="reportFiltersTable" class="subFormTable" runat="server">
                            ...
                            <tr>
                                ...
                                <td class="inputcontrols">
                                    <asp:TextBox ID="txtSalesInvoiceDate" runat="server" Enabled="false" SkinID="TextBoxCalendarExtenderDisabled"></asp:TextBox>
                                </td>
                                <td class="label">
                            ...
                            <tr>
                                ...
                                <td class="inputcontrols">
                                    ...
                                    <asp:HiddenField ID="hdnCalamityCess" runat="server" />
                                    <asp:HiddenField ID="hdnCostToCostCoupon" runat="server" />
                                </td>
                                <td class="label">
                                ...
                                <td class="inputcontrols">
                                    <asp:DropDownList ID="ddlSalesReqNumber" runat="server" SkinID="DropDownListNormal"
                                        AutoPostBack="True" OnSelectedIndexChanged="ddlSalesReqNumber_OnSelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="inputcontrols">
                                    <asp:DropDownList ID="ddlCashDiscount" runat="server" SkinID="DropDownListNormal"
                                        AutoPostBack="True" OnSelectedIndexChanged="ddlCashDiscount_OnSelectedIndexChanged">
                                    </asp:DropDownList>
                                    <asp:HiddenField ID="hdnCDstatus" runat="server" />
                                </td>
                                <td class="label">
                            ...
                            <tr style="display: none">
                                <td class="label">
                                    <asp:Label ID="Label30" runat="server" Text="Advance Indicator" SkinID="LabelNormal"></asp:Label>
                                    <span class="asterix">*</span>
                                </td>
                                <td class="inputcontrols">
                                    <asp:RadioButtonList runat="server" ID="rdAdvanceIndicator" RepeatDirection="Horizontal"
                                        AutoPostBack="true" SkinID="RadioButtonNormal" OnSelectedIndexChanged="rdAdvanceIndicator_OnSelectedIndexChanged">
                                        <asp:ListItem Value="Y">Yes</asp:ListItem>
                                        <asp:ListItem Value="N" Selected="True">No</asp:ListItem>
                                    </asp:RadioButtonList>
                                </td>
                                <td class="label">
                                    <asp:Label ID="lblAdvReceiptNumber" runat="server" Text="Receipt Number" SkinID="LabelNormal"></asp:Label>
                                </td>
                                <td class="inputcontrols">
                                    <asp:TextBox ID="txtAdvReceiptNumber" runat="server" SkinID="TextBoxNormal"></asp:TextBox>
                                </td>
                                <td class="label">
                                    <asp:Label ID="lblAdvReceiptDate" runat="server" Text="Receipt Date" SkinID="LabelNormal"></asp:Label>
                                </td>
                                <td class="inputcontrols">
                                    <asp:TextBox ID="txtAdvReceiptDate" runat="server" SkinID="TextBoxNormal"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                    ...
                    <table runat="server">
                        <tr runat="server">
                            <td runat="server">
                                <div class="subFormTitle">SHIPPING ADDRESS</div>
                            </td>
                            <td>&nbsp;</td>
                            <td id="ShipAdd1" class="label" runat="server">
                                <asp:Label ID="Label37" runat="server" SkinID="LabelNormal" Text="Shipping Address" Style="font-weight: bold; color: #1818a1; font-size: 18px"></asp:Label>
                            </td>
                            <td id="ShipAdd2" runat="server">
                                <asp:DropDownList ID="ddlShippingAddress" runat="server" SkinID="DropDownListNormal" AutoPostBack="true" OnSelectedIndexChanged="ddlShippingAddress_OnSelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                        </tr>
                    </table>
                    <asp:Panel ID="PanelShippingDtls" runat="server">
                        <table class="subFormTable">
                            <tr>
                                <td class="label">
                            ...
                            <tr>
                                ...
                                <td class="inputcontrols">
                                    <asp:TextBox ID="txtPhone" runat="server" SkinID="TextBoxNormal" ReadOnly="true" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                    ...
                    <asp:Panel ID="panelReceipt" runat="server" CssClass="subFormPanelGrayInvisible">
                        ...
                        <table class="subFormTable">
                            <tr>
                                ...
                                <td class="inputcontrols">
                                    <asp:DropDownList ID="ddlModeOfREceipt" runat="server" AutoPostBack="False" SkinID="DropDownListNormal">
        ...
        <asp:UpdatePanel ID="UpdPanelGrid" runat="server" UpdateMode="Conditional">
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="ddlCashDiscount" />
                <asp:AsyncPostBackTrigger ControlID="ddlTransactionType" />
            </Triggers>
            <ContentTemplate>
                <div id="divItemDetails" runat="server">
                                ...
                                <asp:Panel ID="PanelOsLsFilter" runat="server" CssClass="subFormPanelGrayInvisible">
                                    <table cellpadding="5" cellspacing="10">
                                        <tr>
                                            ...
                                            <td class="inputcontrols">
                                                <asp:DropDownList ID="ddlOsLsFilter" runat="server" AutoPostBack="true" SkinID="DropDownListNormal"
                                                    OnSelectedIndexChanged="ddlOsLsFilter_OnSelectedIndexChanged">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <asp:Panel ID="PanelTaxFilter" runat="server" CssClass="subFormPanelGrayInvisible">
                                    <table cellpadding="5" cellspacing="10">
                                        <tr>
                                            ...
                                            <td class="inputcontrols">
                                                <asp:DropDownList ID="ddlTaxFilter" runat="server" AutoPostBack="true" SkinID="DropDownListNormal"
                                                    OnSelectedIndexChanged="ddlTaxFilter_OnSelectedIndexChanged">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
                    ...
                    <div>
                        <asp:GridView ID="grvItemDetails" runat="server" AutoGenerateColumns="False" OnRowDataBound="grvItemDetails_OnRowDataBound"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Req.Qty/Available">
                                    <ItemTemplate>
                                        ...
                                        <asp:TextBox ID="txtCanOrderQty" runat="server" SkinID="GridViewTextBoxSmall" Enabled="false"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Branch List Price">
                                    <ItemTemplate>
                                        ...
                                        <asp:TextBox ID="txtCostPrice" runat="server" SkinID="gridviewTextBoxSmall" Visible="false"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtDiscount" runat="server" SkinID="gridviewTextBoxSmall" OnTextChanged="txtDiscount_TextChanged"
                                            AutoPostBack="True" onkeypress="return CurrencyNumberOnly();" onkeyup="return CurrencyDecimalOnly(this.id, event);"></asp:TextBox>/
                                        <asp:TextBox ID="txtOrgCoupon" runat="server" SkinID="GridViewTextBoxSmall" Enabled="false"></asp:TextBox>
                                        <asp:HiddenField ID="txtHdnCouponInd" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Sales Tax %">
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="txtAddlTax" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="GP %">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtGrossProfit" runat="server" SkinID="gridviewTextBoxSmall" Enabled="false"
                                            Style="width: 60px !important;"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Item Code" Visible="false">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtItemCode" runat="server" Enabled="false" SkinID="GridViewTextBoxSmall"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                    ...
                    <asp:HiddenField ID="hdnDispLocInd" runat="server" />
                    <asp:HiddenField ID="hdnDispLocCnt" runat="server" />
                </div>
                <div class="transactionButtons">
                    <div class="transactionButtonsHolder">
                        ...
                        <asp:Button ID="BtnReportOs" SkinID="ButtonNormal" runat="server" Text="OS Details" Style="display: none" OnClick="BtnReportOs_Click" />
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        ...
        <UC:CrystalReport runat="server" ID="crySalesInvoiceReprint" OnUnload="crySalesInvoiceReprint_Unload" />
    </div>
