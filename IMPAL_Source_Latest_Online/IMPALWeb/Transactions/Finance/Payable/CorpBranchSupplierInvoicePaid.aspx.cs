...
{
    public partial class CorpBranchSupplierInvoicePaid : System.Web.UI.Page
    {
        ...
        protected void GenerateAndExportReport(string fileType)
        {
            ...
            crBranchSupplierInvoice.ReportName = "CorpBranchSupplierInvoicePaid";
            crBranchSupplierInvoice.CrystalFormulaFields.Add("fromdate", "\"" + txtFromDate.Text + "\"");
            crBranchSupplierInvoice.CrystalFormulaFields.Add("todate", "\"" + txtToDate.Text + "\"");
            crBranchSupplierInvoice.RecordSelectionFormula = strSelectionFormula;
            crBranchSupplierInvoice.GenerateReportAndExportA4HO(fileType);
        }
        #endregion
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("CorpBranchSupplierInvoicePaid.aspx", false);
