<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="HOPayment.aspx.cs"
    Inherits="IMPALWeb.Transactions.Finance.Payable.HOPayment" EnableEventValidation="false" %>
...
<%@ Register Src="~/UserControls/HoPaymentInvDetails.ascx" TagName="HOPaymentInvDetails"
    TagPrefix="uc2" %>
<asp:Content ID="Content3" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function CalculateTotal() {
            ...
            var grd = document.getElementById(CtrlIdPrefix + "grvHOPaymentDetails");
        ...
        function CalculateTotalHO(id) {
            ...
            var grdid = id.split("grvHOPaymentInvoiceDetails");
            var grd = document.getElementById(grdid[0] + "grvHOPaymentInvoiceDetails");
        ...
        function showHoPaymentChild(id) {
            var branchid = id.replace("editHOPaymentDet_btnEdit", "txtBranch");
            var amountid = id.replace("editHOPaymentDet_btnEdit", "txtInvoiceAmount");
            var cdamtid = id.replace("editHOPaymentDet_btnEdit", "txtCDAmount");
            var branch = document.getElementById(branchid).value;
            var amount = Math.round(parseFloat(document.getElementById(amountid).value) * 100) / 100;
            var cdamt = Math.round(parseFloat(document.getElementById(cdamtid).value) * 100) / 100;
        ...
        <asp:UpdatePanel ID="UpdPanelGrid" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div id="idGrid" runat="server">
                    <asp:GridView ID="grvHOPaymentDetails" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="">
                                <ItemTemplate>
                                    <uc2:HOPaymentInvDetails runat="server" DefaultBranch="true" ID="editHOPaymentDet"
                                        OnSearchImageClicked="ucHOPaymentInvDetails_SearchImageClicked" />
                                </ItemTemplate>
                            </asp:TemplateField>
