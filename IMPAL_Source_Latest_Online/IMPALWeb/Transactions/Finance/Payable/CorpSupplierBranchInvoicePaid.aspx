<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CorpSupplierBranchInvoicePaid.aspx.cs"
    Inherits="IMPALWeb.Transactions.Finance.Payable.CorpSupplierBranchInvoicePaid" %>
    ...
    <asp:UpdatePanel ID="upHeader" runat="server" UpdateMode="Conditional">
        ...
        <ContentTemplate>
            <asp:Panel ID="PanelHeaderDtls" runat="server">
                <div class="reportFilters">
                    <table id="reportFiltersTable" class="reportFiltersTable" runat="server">
                        <tr>
                            <td class="label">
                                <asp:Label ID="lblSupplierCode" Text="Supplier Line" SkinID="LabelNormal" runat="server"></asp:Label>
                            </td>
            ...
            <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
                <UC:CrystalReport ID="crSupplierBranchInvoice" runat="server" ReportName="CorpSupplierBranchInvoicePaid" />
            </div>
