...
{
    public partial class CashAndBankReceipt : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            {
                Log.WriteException(typeof(CashAndBankReceipt), exp);
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (grvCashAndBankReceipt.Visible == false)
                {
                    BtnSubmit.Visible = false;
        ...
        protected void btnReset_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("CashAndBankReceipt.aspx", false);
        ...
        {
            Type Source = System.Reflection.MethodBase.GetCurrentMethod().DeclaringType;
            DataTable pdtCashAndBankReceipt = new DataTable();
            try
            {
                grvCashAndBankReceipt.Visible = true;
                grvCashAndBankReceipt.Enabled = true;
