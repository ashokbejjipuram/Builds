<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="CashAndBankReceiptNEFTExcel.aspx.cs" Inherits="IMPALWeb.Finance.CashAndBankReceiptNEFTExcel" %>
...
<asp:Content ID="cntCashAndBankReceiptNEFTExcel" ContentPlaceHolderID="CPHDetails" runat="server">
    <script src="../../../Javascript/CashAndBankReceiptNEFTExcel.js" type="text/javascript"></script>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DownLoadExcelFile(uid) {
            ...
            //if (typeof console !== 'undefined') console.log(new Date());
            alert('Duplicate Records Exists. Please Check and Upload the file');            
        }
    </script>
            ...
            <ContentTemplate>
                <div id="divCashAndBankReceipt" runat="server">
                    <div class="subFormTitle subFormTitleExtender350">
                        CASH & BANK - RECEIPTS - BRANCH NEFT EXCEL
                    </div>
                    <table id="reportFiltersTable" class="subFormTable" runat="server">
                        ...
                        <tr>
                            ...
                            <td class="inputcontrols">
                                <asp:TextBox ID="txtTransactionAmount" runat="server" SkinID="TextBoxNormal"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="label">
                            ...
                            <td class="inputcontrols">
                                <asp:TextBox ID="txtBank" runat="server" SkinID="TextBoxDisabled" onkeypress="return AlphaNumericOnlyWithSpace();" Enabled="false"></asp:TextBox>
                                <input type="hidden" runat="server" id="hdnBank" />
                            </td>
                            <td class="label">
                                <asp:Label ID="lblBankBranch" runat="server" SkinID="LabelNormal" Text="Bank Branch"></asp:Label>
                            </td>
                            <td class="inputcontrols">
                                <asp:TextBox ID="txtBankBranch" runat="server" SkinID="TextBoxDisabled" onkeypress="return AlphaNumericOnlyWithSpace();" Enabled="false"></asp:TextBox>
                                <input type="hidden" runat="server" id="hdnBankBranch" />
                            </td>
                        </tr>
                        <tr style="display: none">
                            ...
                            <td class="inputcontrols" style="display: none">
                                <asp:DropDownList ID="ddlCashCheque" runat="server" AutoPostBack="False" SkinID="DropDownListNormal" Enabled="false">
                                </asp:DropDownList>
                            </td>
                            <td class="label" style="display: none">
                            ...
                            <td class="inputcontrols" style="display: none">
                                <asp:TextBox ID="txtReferenceDate" runat="server" onblur="return checkDateForRefDocDate(this.id);"
                    ...
                    <table class="subFormTable" style="display: none">
                        <tr>
                            ...
                            <td class="inputcontrols">
                                <asp:TextBox ID="txtChequeDate" onblur="return checkDateForRefDocDate(this.id, true,'Cheque Date');"
                                ...
                                <input type="hidden" runat="server" id="hdnChequeDate" />
                            </td>
                        </tr>
                        <tr>
                            <td class="label">
                            ...
                            <td class="inputcontrols">
                                ...
                                <input type="hidden" runat="server" id="hdnLocalOutstation" />
                            </td>
                        </tr>
                    </table>
                    ...
                    <div id="divItemDetails" runat="server">
                        ...
                        <div class="gridViewScrollFullPage">
                            <asp:GridView ID="grvCashAndBankReceiptNEFTExcel" runat="server" AutoGenerateColumns="False"
                                OnRowDataBound="gvResults_RowDataBound" SkinID="GridViewTransaction" PageSize="10000">
                                <EmptyDataTemplate>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="S.No">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtSNo" runat="server" Text='<%# Container.DataItemIndex + 1 %>'
                                                Enabled="false" SkinID="TextBoxDisabledSmall"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Chart of Account" Visible="false">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtGrdChartOfAccount" runat="server" SkinID="GridViewTextBoxBig" ReadOnly="true" Text='<%# Bind("Chart_of_Account_Code") %>'></asp:TextBox>
                                            <uc1:ChartAccount ID="COA" runat="server" DefaultBranch="true" OnSearchImageClicked="COA_SearchImageClicked" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Branch">
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddlBranch" runat="server" SkinID="GridViewDropDownList" Text='<%#Bind("Branch") %>' Style="width: 150px !important;" DataSourceID="ODS_AllBranch"
                                    ...
                                    <asp:TemplateField HeaderText="Amount">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtAmount" runat="server" SkinID="GridViewTextBox" Text='<%#Bind("Amount","{0:0.00}") %>' style="width:100px"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Bank Ref. No.">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtBankRefNo" runat="server" SkinID="GridViewTextBoxBig" Text='<%#Bind("BankRefNo") %>' style="width:100px"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="NEFT Date">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtNEFTDate" runat="server" SkinID="TextBoxCalendarExtenderNormal" Text='<%#Bind("NeftDate") %>' style="width:70px"></asp:TextBox>
                                            <ajaxToolkit:CalendarExtender ID="ceRequDocDate" PopupButtonID="imgRequDocDate" Format="dd/MM/yyyy"
                                                runat="server" TargetControlID="txtNEFTDate" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Remarks">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtRemarks" runat="server" SkinID="GridViewTextBoxBig" Text='<%#Bind("Remarks") %>' style="width:300px"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                    ...
                    <div class="transactionButtons">
                        <div class="transactionButtonsHolder">
                            <asp:Button ID="BtnSubmit" runat="server" Text="Submit" SkinID="ButtonNormal" OnClick="BtnSubmit_Click"
                                OnClientClick="javascript: return ValidateTransactionFields(3);" />
