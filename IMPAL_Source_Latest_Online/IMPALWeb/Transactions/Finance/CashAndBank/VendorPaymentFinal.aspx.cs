...
{
    public partial class VendorPaymentFinal : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            {
                Log.WriteException(typeof(VendorPaymentFinal), exp);
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    LoadVendorPaymentDocumentsForApproval();
        ...
        private void LoadVendorPaymentDocumentsForApproval()
        {
            List<VendorBookingEntity> lstMiscBillNumber = new List<VendorBookingEntity>();
            lstMiscBillNumber = vendorPayment.GetVendorPaymentDocumentsForApproval(Session["BranchCode"].ToString());
        ...
        protected void ddlDocumentNumber_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (lstDocumentNumber.Status == "A")
                    {
                        if (lstDocumentNumber.AuthorityMatrixStatus == "0")
                        {
                        ...
                        else if (lstDocumentNumber.AuthorityMatrixStatus == "1")
                        {
                            BtnSubmit.Visible = false;
            ...
            {
                Log.WriteException(typeof(VendorPaymentFinal), ex);
            }
        }
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int result = vendorPayment.AddVendorPaymentEntryFinal(ref vendorpaymentHeader);
                if (result == 1 && vendorpaymentHeader.ErrorMsg == string.Empty && vendorpaymentHeader.ErrorCode == "0")
                {
                    ...
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "IMPAL", "alert('Vendor Payment Has Been Approved Successfully.');", true);
                }
                else
                {
                    txtHdnGridCtrls.Attributes.Add("Style", "display:none");
        ...
        protected void BtnCancel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                vendorPayment.CancelVendorPaymentEntry(Session["BranchCode"].ToString(), ddlDocumentNumber.SelectedValue, "I", "I", Session["VendorRemarks"].ToString());
        ...
        protected void BtnReject_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                BtnReject.Visible = false;
                ddlDocumentNumber.Enabled = false;
                vendorPayment.CancelVendorPaymentEntry(Session["BranchCode"].ToString(), ddlDocumentNumber.SelectedValue, "I", "R", Session["VendorRemarks"].ToString());
        ...
        protected void btnReset_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Server.ClearError();
                Response.Redirect("VendorPaymentFinal.aspx", false);
        ...
        private void LoadAccountintPeriod()
        {
            ...
            int PrevFinYearStatus = objReceivableInvoice.GetPreviousAccountingPeriodStatus(Session["UserID"].ToString(), "VPApproval");
