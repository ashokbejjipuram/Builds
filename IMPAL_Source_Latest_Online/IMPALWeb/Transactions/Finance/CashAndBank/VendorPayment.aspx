<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="VendorPayment.aspx.cs"
    Inherits="IMPALWeb.Finance.VendorPayment" EnableEventValidation="false" %>

<%@ Register Src="~/UserControls/CrystalReportExportA4.ascx" TagName="CrystalReport" TagPrefix="UC" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register TagPrefix="uc1" TagName="ChartAccount" Src="~/UserControls/ChartAccountOtherBranches.ascx" %>
<asp:Content ID="Content3" ContentPlaceHolderID="CPHDetails" runat="server">

    <script src="../../../Javascript/VendorPayment.js" type="text/javascript"></script>
                ...
                <div>
                    ...
                    <table class="subFormTable">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <asp:Label ID="lblTransNumber" runat="server" Text="Other Branch Vendors #" SkinID="LabelNormal"></asp:Label>
                                <span class="asterix">*</span>
                            </td>
                            <td class="inputcontrols">
                                <asp:DropDownList ID="ddlVendorCodeOthers" runat="server" SkinID="DropDownListNormal"
                                    AutoPostBack="true" OnSelectedIndexChanged="ddlVendorCodeOthers_OnSelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            <td class="label">
                        ...
                        <tr>
                            ...
                            <td class="inputcontrols">
                                <asp:TextBox ID="txtAmount" runat="server" SkinID="TextBoxNormal" contentEditable="true" MaxLength="11"
                            ...
                            <td class="inputcontrols" colspan="3">
                                <asp:TextBox ID="txtNarration" runat="server" SkinID="TextBoxMultilineNormalFiveColBig"
                                    TextMode="MultiLine" Style="width: 200px"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                    <div class="subFormTitle">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <div class="gridViewScrollFullPage">
                            ...
                            <asp:GridView ID="grvVendorPaymentDetails" runat="server" AutoGenerateColumns="False"
                                AllowPaging="false" SkinID="GridViewTransaction" OnRowDataBound="grvVendorPaymentDetails_RowDataBound">
                                <EmptyDataTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Booking Date">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtBookingDate" runat="server" ReadOnly="true" Text='<%# Bind("DocumentDate") %>'
                                                SkinID="TextBoxDisabled" Style="width: 75px"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Ref. Date">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtReferenceDate" runat="server" ReadOnly="true" Text='<%# Bind("InvoiceDate") %>'
                                                SkinID="TextBoxDisabled" Style="width: 70px"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Booking Amount">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtBookingAmount" ReadOnly="true" runat="server" SkinID="TextBoxDisabled"
                                                Text='<%# Bind("InvoiceValue") %>' Style="width: 100px" onpaste="return false;" ondrag="return false;"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="TDS Amount">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtTDSAmount" ReadOnly="true" runat="server" SkinID="TextBoxDisabled"
                                                Text='<%# Bind("TDSAmount") %>' Style="width: 80px" onpaste="return false;" ondrag="return false;"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Paid Amount">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtPaidAmount" ReadOnly="true" runat="server" SkinID="TextBoxDisabled"
                                                Text='<%# Bind("PaidAmount") %>' Style="width: 80px" onpaste="return false;" ondrag="return false;"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Payment Amount">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtPaymentAmount" runat="server" SkinID="TextBoxNormal" Text='<%# Bind("PaymentAmount") %>'
                                                onkeypress="return CurrencyNumberOnly();" Style="width: 110px" onpaste="return false;" ondrag="return false;"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
    ...
    <div class="reportViewerHolder" id="reportViewerHolder" runat="server">
        ...
        <UC:CrystalReport runat="server" ID="crVendorPaymentReport" OnUnload="crVendorPaymentReport_Unload" />
    </div>
