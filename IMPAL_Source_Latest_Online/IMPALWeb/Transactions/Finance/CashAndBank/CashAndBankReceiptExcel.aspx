<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="CashAndBankReceiptExcel.aspx.cs" Inherits="IMPALWeb.Finance.CashAndBankReceiptExcel" %>
...
<asp:Content ID="cntCashAndBankReceiptExcel" ContentPlaceHolderID="CPHDetails" runat="server">

    <script src="../../../Javascript/CashAndBankReceiptExcel.js" type="text/javascript"></script>
            ...
            <ContentTemplate>
                <div id="divCashAndBankReceipt" runat="server">
                    ...
                    <div id="divItemDetails" runat="server">
                        <div class="subFormTitle">
                            Cash & Bank Details</div>
                        <div class="gridViewScrollFullPage">
                            <asp:GridView ID="grvCashAndBankReceiptExcel" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Chart of Account">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtChartOfAccount" runat="server" SkinID="GridViewTextBoxBig" ReadOnly="true"
                                    ...
                                    <asp:TemplateField HeaderText="Amount">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtAmount" onpaste="return false;" onkeypress="return CurrencyNumberOnly();" runat="server"
                                                SkinID="GridViewTextBox" Text='<%#Bind("Amount","{0:0.00}") %>' ondragstart="return false;" ondrop="return false;"></asp:TextBox>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Remarks">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtRemarks" runat="server" SkinID="GridViewTextBoxBig" Text='<%#Bind("Remarks") %>'></asp:TextBox>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                        </FooterTemplate>
                                    </asp:TemplateField>
