<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="InterBranchPayment.aspx.cs" Inherits="IMPALWeb.Finance.InterBranchPayment" %>
...
<asp:Content ID="cntCashAndBankPayment" ContentPlaceHolderID="CPHDetails" runat="server">
    ...
    <script src="../../../Javascript/InterBranchPayment.js" type="text/javascript"></script>
                ...
                <div id="divCashAndBankPayment" runat="server">
                        ...
                        <tr>
                            ...
                            <td class="inputcontrols">
                                <asp:DropDownList ID="ddlPayment" runat="server" AutoPostBack="True" SkinID="DropDownListNormal"
                                    Enabled="false" OnSelectedIndexChanged="ddlPayment_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            <td class="label">
                                <asp:Label ID="lblBranchOthers" runat="server" Text="Other Branch" SkinID="LabelNormal"></asp:Label>
                                <span class="asterix">*</span>
                            </td>
                            <td class="inputcontrols">
                                <asp:DropDownList ID="ddlBranchOthers" runat="server" DataTextField="BranchName" DataValueField="BranchCode"
                                    SkinID="DropDownListNormal" AutoPostBack="true" OnSelectedIndexChanged="ddlBranchOthers_IndexChanged" />
                            </td>
                        </tr>
                        <tr>
                            <td class="label">
                            ...
                            <td class="inputcontrols">
                                <asp:TextBox ID="txtTransactionAmount" runat="server" SkinID="TextBoxNormal" onkeypress="return CurrencyNumberOnly();"></asp:TextBox>
                            </td>
                            <td class="label">
                    ...
                    <div id="divItemDetails" runat="server">
                        ...
                        <div class="gridViewScrollFullPage">
                            <asp:GridView ID="grvInterBranchPayment" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Amount">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtAmount" onkeypress="return CurrencyNumberOnly();" runat="server"
                                                Text='<%# Bind("Amount","{0:0.00}") %>' SkinID="GridViewTextBox"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                        ...
                        <div class="transactionButtons">
                            <div class="transactionButtonsHolder">
                                <asp:Button ID="btnReportTransaction" runat="server" Text="Transaction Details" SkinID="ButtonNormalBig"
                                    OnClick="btnReportTransaction_Click" OnClientClick="javascript: return ValidateTransactionFields();" />
