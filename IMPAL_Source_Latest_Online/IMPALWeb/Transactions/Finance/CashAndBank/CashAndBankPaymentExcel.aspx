<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="CashAndBankPaymentExcel.aspx.cs" Inherits="IMPALWeb.Finance.CashAndBankPaymentExcel" %>
...
<asp:Content ID="cntCashAndBankPaymentExcel" ContentPlaceHolderID="CPHDetails" runat="server">

    <script src="../../../Javascript/CashAndBankPaymentExcel.js" type="text/javascript"></script>
                ...
                <div id="divCashAndBankReceipt" runat="server">
                    ...
                    <div id="divItemDetails" runat="server">
                        ...
                        <div class="gridViewScrollFullPage">
                            <asp:GridView ID="grvCashAndBankPaymentExcel" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Amount">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtAmount" onkeypress="return CurrencyNumberOnly();" runat="server" onpaste="return false;"
