...
{
    public partial class JournalVoucherAdm : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            {
                Log.WriteException(typeof(JournalVoucherAdm), exp);
            }
        }
        ...
        protected void btnReset_Click(object sender, EventArgs e)
        {
            ...
            {
                Server.ClearError();
                Response.Redirect("JournalVoucherAdm.aspx", false);
