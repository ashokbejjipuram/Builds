<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyReport.aspx.cs" Inherits="IMPALWeb.Dashboard.FinanceDashboard.DailyReport"%>
...
<div class="reportFormTitle reportFormTitleExtender350">
    ...
    <div class="dashReportHolder" id="dashReportHolder" runat="server">
        <UC:SSRSReport ID="DashDailyReport" runat="server" />
    </div>
</asp:Content>
