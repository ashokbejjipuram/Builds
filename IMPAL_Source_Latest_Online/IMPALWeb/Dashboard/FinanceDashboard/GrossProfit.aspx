<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="GrossProfit.aspx.cs" Inherits="IMPALWeb.Dashboard.FinanceDashboard.GrossProfit" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHDetails" runat="server">
    <div class="reportFormTitle reportFormTitleExtender350">
        Finance Dashboard - Gross Profit
    </div>
    <div>
            ...
            <tr>
                ...
                <td class="inputcontrols" style="width: 140px; height: 144px">
                    <asp:DropDownList ID="ddlReportList" runat="server" SkinID="DropDownListNormal" TabIndex="1" AutoPostBack="True" Height="29px" Width="179px">
                        ...
                        <asp:ListItem>ACC GP % </asp:ListItem>
                        <asp:ListItem>ACC CUMU</asp:ListItem>
                        <asp:ListItem>ACC MTH</asp:ListItem>
                        <asp:ListItem>INV GP %</asp:ListItem>
                        <asp:ListItem>SOUTH GP %</asp:ListItem>
                        <asp:ListItem>REST OF INDIA GP %</asp:ListItem>
                        <asp:ListItem>INV GP MONTH</asp:ListItem>
                        <asp:ListItem>INV GP CUMM</asp:ListItem>
                        <asp:ListItem>ACC AND INV GP %</asp:ListItem>
    ...
    <div class="dashReportHolder" id="dashReportHolder" runat="server">
        <UC:SSRSReport ID="DashGrossProfit" runat="server" />
    </div>
</asp:Content>
